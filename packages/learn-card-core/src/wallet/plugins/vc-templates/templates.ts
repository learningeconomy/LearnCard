...
export const VC_TEMPLATES: { [Key in keyof VcTemplates]: (args: VcTemplates[Key]) => UnsignedVC } =
    {
        ...
        fullAchievement: ({
            ...
            achievementName = '1EdTech University Degree',
                                ...
                                proof: [
                                    {
                                        ...
                                        verificationMethod:
                                            'https://accrediter.edu/issuers/565049#key-1',
                                        proofPurpose: 'assertionMethod',
                                        proofValue:
                                            'zvPkQiUFfJrgnCRhyPkTSkgrGXbnLR15pHH5HZVYNdM4TCAwQHqG7fMeMPLtYNRnEgoV1aJdR5E61eWu5sWRYgtA',
                                    },
                                ],
                            },
                            {
                                ...
                                proof: [
                                    {
                                        ...
                                        proofPurpose: 'assertionMethod',
                                        proofValue:
                                            'z5bDnmSgDczXwZGya6ZjxKaxkdKxzsCMiVSsgEVWxnaWK7ZqbKnzcCd7mUKE9DQaAL2QMXP5AquPeW6W2CWrZ7jNC',
                                    },
                                ],
                            },
                        ],
