...
const cases: VCDisplayCase[] = [
    ...
    },
    {
        ...
        props: matrixType => ({
            ...
            categoryType: matrixTypeConfig[matrixType].categoryType,
            issuerContext: {
                issuerDid: fingerprintDidSet.webIssuer,
                state: 'unresolvable',
                trustProfile: 'credential',
                connectionStatus: 'NOT_CONNECTED',
                mutualConnectionCount: 0,
            ...
            issuerLabel: 'Issuer could not be identified',
            isFrontOverride: true,
            verificationItems: BASE_VERIFICATION_ITEMS,
        }),
    },
    {
        ...
        props: matrixType => ({
            ...
            categoryType: matrixTypeConfig[matrixType].categoryType,
            issuerContext: {
                issuerDid: fingerprintDidSet.jwkIssuer,
                state: 'unresolvable',
                trustProfile: 'credential',
                connectionStatus: 'NOT_CONNECTED',
                mutualConnectionCount: 0,
    ...
    },
    {
        ...
        props: matrixType => ({
            ...
            categoryType: matrixTypeConfig[matrixType].categoryType,
            issuerContext: {
                issuerDid: fingerprintDidSet.peerIssuer,
                state: 'identified',
                trustProfile: 'social',
                connectionStatus: 'NOT_CONNECTED',
                mutualConnectionCount: 0,
    ...
    },
    {
        ...
        props: matrixType => ({
            ...
            categoryType: matrixTypeConfig[matrixType].categoryType,
            issuerContext: {
                issuerDid: fingerprintDidSet.webSelfIssued,
                state: 'self',
                trustProfile: 'credential',
                connectionStatus: 'NOT_CONNECTED',
                mutualConnectionCount: 0,
