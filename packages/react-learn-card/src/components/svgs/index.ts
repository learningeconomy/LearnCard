...
export * from "./AwardDisplayIcon";
export * from "./AwardRibbon";
export * from "./BadgeDisplayIcon";
export * from "./Briefcase";
export * from "./Camera";
export * from "./CertificateDisplayIcon";
export * from "./Checkmark";
export * from "./CircleWithText";
export * from "./Coins";
export * from "./CourseDisplayIcon";
...
export * from "./IDDisplayIcon";
export * from "./IDIcon";
export * from "./IDSleeve";
