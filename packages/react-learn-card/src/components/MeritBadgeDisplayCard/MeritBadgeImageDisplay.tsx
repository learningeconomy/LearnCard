...
const MeritBadgeImageDisplay: React.FC<MeritBadgeImageDisplayProps> = ({
    ...
    return (
        ...
        >
            <div className="relative left-[1px] top-[1px] w-full h-full p-[10px] flex items-center justify-center rounded-full overflow-hidden object-contain z-[10000]">
                <img src={imageUrl} alt="merit badge thumbnail" />
            </div>

            <MeritBadgeRibbon className={`absolute z-[9999]`} />
        </div>
    );
};
