...
export const SmallVCCard: React.FC<SmallVCCardProps> = ({
    ...
    return (
        ...
        >
            <section className="h-[110px] bg-indigo-200 flex-col justify-center items-center w-full rounded-[20px]">
                {thumbImgSrc && (
                    <img
                ...
                {(!thumbImgSrc || thumbImgSrc === '') && (
                    <Trophy className="achievement-placeholder-trophy p-[15px]" color="#ffffff" />
                )}
            </section>
