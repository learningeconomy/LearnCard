...
export const EN_DEFAULTS: Record<string, string> = {
    ...
    'credential.about': 'About',
    'credential.criteria': 'Criteria',
    'credential.alignments': 'Alignments',
    'credential.alignmentInfo':
        'Alignments in your Open Badge credential link your achievement to established frameworks, standards, or competencies. Each alignment shows how your boost directly relates to skills, knowledge areas, and professional standards that are recognized in your field.',
    'credential.verifiedSource': 'Verified source',
    'credential.occupationsPrograms': 'Occupations & programs',
    'credential.verifiedLabel': 'Verified',
    'credential.openAlignmentSource': 'Open alignment source',
    'credential.more': 'More',
    'credential.close': 'Close',
    'credential.by': 'By',
    'credential.verified': 'Verified Credential',
