...
> BoostGetBoost200ResponseClaimPermissions boostGetOtherBoostPermissions(profileId, uri)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uri = "uri_example"; // String | 
    try {
      BoostGetBoost200ResponseClaimPermissions result = apiInstance.boostGetOtherBoostPermissions(profileId, uri);
      System.out.println(result);
    } catch (ApiException e) {
