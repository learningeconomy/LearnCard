...
> ProfileGetProfile200Response profileGetOtherProfile(profileId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String profileId = "profileId_example"; // String | 
    try {
      ProfileGetProfile200Response result = apiInstance.profileGetOtherProfile(profileId);
      System.out.println(result);
    } catch (ApiException e) {
...
[**ProfileGetProfile200Response**](ProfileGetProfile200Response.md)
...
# **profileGetProfile**
> ProfileGetProfile200Response profileGetProfile()
...
public class Example {
  public static void main(String[] args) {
    ...
    ProfilesApi apiInstance = new ProfilesApi(defaultClient);
    try {
      ProfileGetProfile200Response result = apiInstance.profileGetProfile();
      System.out.println(result);
    } catch (ApiException e) {
...
> ProfileSigningAuthority200Response profileSigningAuthority(endpoint, name)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProfileSigningAuthority200Response result = apiInstance.profileSigningAuthority(endpoint, name);
      System.out.println(result);
    } catch (ApiException e) {
