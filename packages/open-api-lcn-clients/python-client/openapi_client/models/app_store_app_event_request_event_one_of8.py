...
class AppStoreAppEventRequestEventOneOf8(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['get-counter']):
            raise ValueError("must be one of enum values ('get-counter')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppStoreAppEventRequestEventOneOf8 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppStoreAppEventRequestEventOneOf8 from a dict"""
        if obj is None:
            return None
