...
class ContractsUpdateConsentedContractTermsRequestTermsRead(BaseModel):
    """
    ContractsUpdateConsentedContractTermsRequestTermsRead
    """ # noqa: E501
    anonymize: Optional[StrictBool] = None
    credentials: Optional[ContractsUpdateConsentedContractTermsRequestTermsReadCredentials] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": ContractsUpdateConsentedContractTermsRequestTermsReadCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
