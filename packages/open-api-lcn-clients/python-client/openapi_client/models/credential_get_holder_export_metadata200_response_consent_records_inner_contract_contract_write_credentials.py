...
class CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractWriteCredentials(BaseModel):
    """
    CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractWriteCredentials
    """ # noqa: E501
    categories: Dict[str, CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractReadPersonalValue]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractWriteCredentials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractWriteCredentials from a dict"""
        if obj is None:
            return None
