...
class ErrorINTERNALSERVERERROR(BaseModel):
    ...
    """ # noqa: E501
    message: StrictStr = Field(description="The error message", json_schema_extra={"examples": ["Internal server error"]})
    code: StrictStr = Field(description="The error code", json_schema_extra={"examples": ["INTERNAL_SERVER_ERROR"]})
