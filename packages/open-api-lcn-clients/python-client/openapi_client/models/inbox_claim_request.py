...
class InboxClaimRequest(BaseModel):
    ...
    InboxClaimRequest
    """ # noqa: E501
    credential: InboxClaimRequestCredential
    configuration: Optional[InboxClaimRequestConfiguration] = None
    __properties: ClassVar[List[str]] = ["credential", "configuration"]
