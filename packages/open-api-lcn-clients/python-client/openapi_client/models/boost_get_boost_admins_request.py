...
class BoostGetBoostAdminsRequest(BaseModel):
    """
    ...
    include_self: Optional[StrictBool] = Field(default=True, alias="includeSelf")
    uri: StrictStr
    __properties: ClassVar[List[str]] = ["limit", "cursor", "sort", "includeSelf", "uri"]
