...
class CredentialSendCredentialRequestCredentialAnyOf1RecipientsInnerHeaderEpk(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CredentialSendCredentialRequestCredentialAnyOf1RecipientsInnerHeaderEpk from a JSON string"""
