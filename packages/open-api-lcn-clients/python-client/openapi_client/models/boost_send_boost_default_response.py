...
class BoostSendBoostDefaultResponse(BaseModel):
    """
    BoostSendBoostDefaultResponse
    """ # noqa: E501
    message: StrictStr
    code: StrictStr
    issues: Optional[List[BoostSendBoostDefaultResponseIssuesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "issues": [BoostSendBoostDefaultResponseIssuesInner.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None
        })
        return _obj
