...
class ContractsConsentToContractRequestTermsWrite(BaseModel):
    """
    ContractsConsentToContractRequestTermsWrite
    """ # noqa: E501
    credentials: Optional[ContractsConsentToContractRequestTermsWriteCredentials] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credentials": ContractsConsentToContractRequestTermsWriteCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
