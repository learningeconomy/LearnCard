...
class ContactMethodsVerifyContactMethod200Response(BaseModel):
    """
    ContactMethodsVerifyContactMethod200Response
    """ # noqa: E501
    message: StrictStr
    contact_method: ContactMethodsGetMyContactMethods200ResponseInner = Field(alias="contactMethod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contactMethod": ContactMethodsGetMyContactMethods200ResponseInner.from_dict(obj["contactMethod"]) if obj.get("contactMethod") is not None else None
        })
        return _obj
