...
class ContractsGetConsentedDataForContract200Response(BaseModel):
    ...
    records: List[ContractsGetConsentedDataForContract200ResponseRecordsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [ContractsGetConsentedDataForContract200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
