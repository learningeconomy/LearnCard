...
class ContractsGetTermsTransactionHistoryRequest(BaseModel):
    """
    ...
    uri: StrictStr
    query: Optional[ContractsGetTermsTransactionHistoryRequestQuery] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort"),
            "uri": obj.get("uri"),
            "query": ContractsGetTermsTransactionHistoryRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
