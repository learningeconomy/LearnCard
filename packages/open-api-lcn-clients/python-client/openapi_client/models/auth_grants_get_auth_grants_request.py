...
class AuthGrantsGetAuthGrantsRequest(BaseModel):
    """
    AuthGrantsGetAuthGrantsRequest
    """ # noqa: E501
    limit: Optional[Union[StrictFloat, StrictInt]] = None
    cursor: Optional[StrictStr] = None
    query: Optional[AuthGrantsGetAuthGrantsRequestQuery] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": AuthGrantsGetAuthGrantsRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
