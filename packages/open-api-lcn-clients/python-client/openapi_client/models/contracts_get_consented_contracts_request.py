...
class ContractsGetConsentedContractsRequest(BaseModel):
    """
    ...
    query: Optional[ContractsGetConsentedContractsRequestQuery] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort"),
            "query": ContractsGetConsentedContractsRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
