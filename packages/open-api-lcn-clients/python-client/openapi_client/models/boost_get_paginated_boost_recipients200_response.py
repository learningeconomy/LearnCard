...
class BoostGetPaginatedBoostRecipients200Response(BaseModel):
    ...
    records: List[BoostGetBoostRecipients200ResponseInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [BoostGetBoostRecipients200ResponseInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
