...
class StorageResolve200ResponseAnyOfAnyOfReadCredentials(BaseModel):
    """
    StorageResolve200ResponseAnyOfAnyOfReadCredentials
    """ # noqa: E501
    categories: Dict[str, StorageResolve200ResponseAnyOfAnyOfReadCredentialsCategoriesValue]
