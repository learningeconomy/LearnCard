...
class CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract(BaseModel):
    """
    CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract
    """ # noqa: E501
    contract: CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContract
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contract": CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContract.from_dict(obj["contract"]) if obj.get("contract") is not None else None,
