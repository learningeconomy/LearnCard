...
class ClaimHookCreateClaimHookRequestHookAnyOf(BaseModel):
    """
    ClaimHookCreateClaimHookRequestHookAnyOf
    """ # noqa: E501
    type: StrictStr
    data: ClaimHookCreateClaimHookRequestHookAnyOfData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": ClaimHookCreateClaimHookRequestHookAnyOfData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
