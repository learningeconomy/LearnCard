...
class ProfileGetManagedServiceProfiles200Response(BaseModel):
    """
    ProfileGetManagedServiceProfiles200Response
    """ # noqa: E501
    cursor: Optional[StrictStr] = None
    has_more: StrictBool = Field(alias="hasMore")
    records: List[BoostGetBoostRecipients200ResponseInnerToAnyOf3]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [BoostGetBoostRecipients200ResponseInnerToAnyOf3.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
