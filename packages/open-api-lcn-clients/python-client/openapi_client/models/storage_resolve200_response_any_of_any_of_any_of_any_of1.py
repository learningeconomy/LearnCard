...
class StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOf1(BaseModel):
    ...
    verifiable_credential: Optional[StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOf1VerifiableCredential] = Field(default=None, alias="verifiableCredential")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verifiableCredential": StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOf1VerifiableCredential.from_dict(obj["verifiableCredential"]) if obj.get("verifiableCredential") is not None else None,
