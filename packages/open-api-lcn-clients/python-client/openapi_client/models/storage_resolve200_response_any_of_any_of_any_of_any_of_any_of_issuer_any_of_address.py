...
class StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuerAnyOfAddress(BaseModel):
    """
    ...
    geo: Optional[StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuerAnyOfAddressGeo] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuerAnyOfAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuerAnyOfAddress from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "geo": StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuerAnyOfAddressGeo.from_dict(obj["geo"]) if obj.get("geo") is not None else None
        })
        return _obj
