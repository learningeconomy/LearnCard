...
class ErrorUNAUTHORIZED(BaseModel):
    ...
    """ # noqa: E501
    message: StrictStr = Field(description="The error message", json_schema_extra={"examples": ["Authorization not provided"]})
    code: StrictStr = Field(description="The error code", json_schema_extra={"examples": ["UNAUTHORIZED"]})
