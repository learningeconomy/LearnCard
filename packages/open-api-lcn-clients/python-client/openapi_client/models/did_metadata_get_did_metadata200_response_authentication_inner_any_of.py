...
class DidMetadataGetDidMetadata200ResponseAuthenticationInnerAnyOf(BaseModel):
    ...
    public_key_jwk: Optional[DidMetadataGetDidMetadata200ResponseAuthenticationInnerAnyOfPublicKeyJwk] = Field(default=None, alias="publicKeyJwk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicKeyJwk": DidMetadataGetDidMetadata200ResponseAuthenticationInnerAnyOfPublicKeyJwk.from_dict(obj["publicKeyJwk"]) if obj.get("publicKeyJwk") is not None else None,
