...
class ProfileGetProfile200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["profileId", "displayName", "shortBio", "bio", "did", "isPrivate", "email", "image", "heroImage", "websiteLink", "isServiceProfile", "type", "notificationsWebhook", "display"]
