...
class CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContract(BaseModel):
    """
    CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContract
    """ # noqa: E501
    read: CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractRead
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContract from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read": CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractRead.from_dict(obj["read"]) if obj.get("read") is not None else None,
