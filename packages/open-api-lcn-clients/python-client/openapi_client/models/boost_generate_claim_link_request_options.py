...
class BoostGenerateClaimLinkRequestOptions(BaseModel):
    """
    BoostGenerateClaimLinkRequestOptions
    """ # noqa: E501
    ttl_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ttlSeconds")
    total_uses: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalUses")
    __properties: ClassVar[List[str]] = ["ttlSeconds", "totalUses"]
