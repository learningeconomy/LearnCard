...
class BoostSendBoostRequestCredentialAnyOf1(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "aad": obj.get("aad"),
            "recipients": [BoostSendBoostRequestCredentialAnyOf1RecipientsInner.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None
        })
        return _obj
