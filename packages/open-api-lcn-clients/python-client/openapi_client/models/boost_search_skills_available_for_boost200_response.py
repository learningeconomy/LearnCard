...
class BoostSearchSkillsAvailableForBoost200Response(BaseModel):
    ...
    """ # noqa: E501
    records: List[BoostSearchSkillsAvailableForBoost200ResponseRecordsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [BoostSearchSkillsAvailableForBoost200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
