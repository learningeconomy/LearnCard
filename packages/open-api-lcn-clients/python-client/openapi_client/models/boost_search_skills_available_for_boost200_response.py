...
class BoostSearchSkillsAvailableForBoost200Response(BaseModel):
    """
    BoostSearchSkillsAvailableForBoost200Response
    """ # noqa: E501
    records: List[BoostGetSkillsAvailableForBoost200ResponseInnerSkillsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [BoostGetSkillsAvailableForBoost200ResponseInnerSkillsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
