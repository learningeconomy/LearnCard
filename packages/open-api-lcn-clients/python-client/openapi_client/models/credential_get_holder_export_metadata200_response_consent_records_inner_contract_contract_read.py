...
class CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractRead(BaseModel):
    """
    CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractRead
    """ # noqa: E501
    anonymize: Optional[StrictBool] = None
    credentials: CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractReadCredentials
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContractContractReadCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "personal": dict(
