...
class SkillFrameworksGetById200Response(BaseModel):
    ...
    """ # noqa: E501
    framework: BoostGetBoostFrameworks200ResponseRecordsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "framework": BoostGetBoostFrameworks200ResponseRecordsInner.from_dict(obj["framework"]) if obj.get("framework") is not None else None,
