...
class ProfileSearchProfiles200ResponseInner(BaseModel):
    ...
    """ # noqa: E501
    profile_id: Annotated[str, Field(min_length=3, strict=True, max_length=40)] = Field(alias="profileId")
    ...
    is_service_profile: Optional[StrictBool] = Field(default=False, alias="isServiceProfile")
    type: Optional[StrictStr] = None
    notifications_webhook: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="notificationsWebhook")
    ...
    __properties: ClassVar[List[str]] = ["profileId", "displayName", "shortBio", "bio", "did", "isPrivate", "email", "image", "heroImage", "websiteLink", "isServiceProfile", "type", "notificationsWebhook", "display", "connectionStatus"]
