...
class ProfileSearchProfiles200ResponseInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connectionStatus", "profileId", "displayName", "shortBio", "image", "heroImage", "type", "isServiceProfile", "display", "bio", "websiteLink", "role", "highlightedCredentials", "did", "email", "isPrivate", "profileVisibility", "showEmail", "allowConnectionRequests", "notificationsWebhook", "dob", "country", "locale", "approved"]
