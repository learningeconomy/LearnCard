...
class DidMetadataGetDidMetadata200ResponseVerificationMethodInnerAnyOf(BaseModel):
    """
    ...
    public_key_jwk: Optional[DidMetadataGetDidMetadata200ResponseVerificationMethodInnerAnyOfPublicKeyJwk] = Field(default=None, alias="publicKeyJwk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicKeyJwk": DidMetadataGetDidMetadata200ResponseVerificationMethodInnerAnyOfPublicKeyJwk.from_dict(obj["publicKeyJwk"]) if obj.get("publicKeyJwk") is not None else None,
