...
class ClaimHookGetClaimHooksForBoostRequest(BaseModel):
    """
    ...
    query: Optional[ClaimHookGetClaimHooksForBoostRequestQuery] = None
    uri: StrictStr
    __properties: ClassVar[List[str]] = ["limit", "cursor", "sort", "query", "uri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort"),
            "query": ClaimHookGetClaimHooksForBoostRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None,
            "uri": obj.get("uri")
        })
        return _obj
