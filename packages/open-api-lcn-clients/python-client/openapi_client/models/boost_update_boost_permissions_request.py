...
class BoostUpdateBoostPermissionsRequest(BaseModel):
    """
    BoostUpdateBoostPermissionsRequest
    """ # noqa: E501
    uri: StrictStr
    updates: BoostUpdateBoostPermissionsRequestUpdates
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uri": obj.get("uri"),
            "updates": BoostUpdateBoostPermissionsRequestUpdates.from_dict(obj["updates"]) if obj.get("updates") is not None else None
        })
        return _obj
