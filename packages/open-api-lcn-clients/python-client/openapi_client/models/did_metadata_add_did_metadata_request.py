...
class DidMetadataAddDidMetadataRequest(BaseModel):
    ...
    controller: Optional[BoostSendBoostRequestCredentialAnyOfEvidenceAnyOfType] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "controller": BoostSendBoostRequestCredentialAnyOfEvidenceAnyOfType.from_dict(obj["controller"]) if obj.get("controller") is not None else None,
