...
class InboxGetMyIssuedCredentials200ResponseRecordsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "isSigned", "currentStatus", "isAccepted", "expiresAt", "createdAt", "finalizedAt", "expiredAt", "credentialName", "achievementType", "issuerDid", "webhookUrl", "boostUri", "activityId", "integrationId", "signingAuthority", "guardianEmail", "guardianStatus", "guardianApprovedAt", "guardianApprovedByDid"]
