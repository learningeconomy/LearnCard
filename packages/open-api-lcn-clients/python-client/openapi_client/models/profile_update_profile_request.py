...
class ProfileUpdateProfileRequest(BaseModel):
    ...
    """ # noqa: E501
    profile_id: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=40)]] = Field(default=None, alias="profileId")
    ...
    __properties: ClassVar[List[str]] = ["profileId", "displayName", "shortBio", "bio", "isPrivate", "email", "image", "heroImage", "websiteLink", "type", "notificationsWebhook", "display"]
