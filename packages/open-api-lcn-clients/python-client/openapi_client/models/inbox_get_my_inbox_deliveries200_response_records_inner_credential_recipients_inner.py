...
class InboxGetMyInboxDeliveries200ResponseRecordsInnerCredentialRecipientsInner(BaseModel):
    """
    InboxGetMyInboxDeliveries200ResponseRecordsInnerCredentialRecipientsInner
    """ # noqa: E501
    header: InboxGetMyInboxDeliveries200ResponseRecordsInnerCredentialRecipientsInnerHeader
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InboxGetMyInboxDeliveries200ResponseRecordsInnerCredentialRecipientsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "header": InboxGetMyInboxDeliveries200ResponseRecordsInnerCredentialRecipientsInnerHeader.from_dict(obj["header"]) if obj.get("header") is not None else None,
