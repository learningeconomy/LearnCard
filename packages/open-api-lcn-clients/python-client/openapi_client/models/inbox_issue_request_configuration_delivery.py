...
class InboxIssueRequestConfigurationDelivery(BaseModel):
    ...
    """ # noqa: E501
    suppress: Optional[StrictBool] = Field(default=False, description="Whether to suppress delivery of the credential to the recipient. If true, the email/sms will not be sent to the recipient. Useful if you would like to manually send claim link to your users.")
    template: Optional[InboxIssueRequestConfigurationDeliveryTemplate] = None
