...
class ContractsUpdateConsentedContractTermsRequestTerms(BaseModel):
    """
    ContractsUpdateConsentedContractTermsRequestTerms
    """ # noqa: E501
    read: Optional[ContractsUpdateConsentedContractTermsRequestTermsRead] = None
    write: Optional[ContractsConsentToContractRequestTermsWrite] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read": ContractsUpdateConsentedContractTermsRequestTermsRead.from_dict(obj["read"]) if obj.get("read") is not None else None,
