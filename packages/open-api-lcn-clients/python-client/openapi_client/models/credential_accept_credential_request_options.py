...
class CredentialAcceptCredentialRequestOptions(BaseModel):
    """
    CredentialAcceptCredentialRequestOptions
    """ # noqa: E501
    skip_notification: Optional[StrictBool] = Field(default=False, alias="skipNotification")
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["skipNotification", "metadata"]
