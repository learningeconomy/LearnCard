...
class CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerTermsReadCredentials(BaseModel):
    """
    ...
    categories: Dict[str, CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerTermsReadCredentialsCategoriesValue]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "categories": dict(
                (_k, CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerTermsReadCredentialsCategoriesValue.from_dict(_v))
