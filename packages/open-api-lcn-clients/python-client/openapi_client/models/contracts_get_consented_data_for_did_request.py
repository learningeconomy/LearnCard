...
class ContractsGetConsentedDataForDidRequest(BaseModel):
    """
    ...
    did: StrictStr
    query: Optional[ContractsGetConsentedDataForDidRequestQuery] = None
    __properties: ClassVar[List[str]] = ["limit", "cursor", "sort", "did", "query"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort"),
            "did": obj.get("did"),
            "query": ContractsGetConsentedDataForDidRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
