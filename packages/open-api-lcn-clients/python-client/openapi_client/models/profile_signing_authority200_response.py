...
class ProfileSigningAuthority200Response(BaseModel):
    ...
    """ # noqa: E501
    signing_authority: ProfileSigningAuthority200ResponseSigningAuthority = Field(alias="signingAuthority")
    relationship: ProfileSigningAuthority200ResponseRelationship
