...
class BoostGetBoostFrameworksRequest(BaseModel):
    """
    ...
    query: Optional[BoostGetBoostFrameworksRequestQuery] = None
    __properties: ClassVar[List[str]] = ["uri", "limit", "cursor", "query"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": BoostGetBoostFrameworksRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
