...
class ClaimHookCreateClaimHookRequestHookAnyOf1(BaseModel):
    """
    ClaimHookCreateClaimHookRequestHookAnyOf1
    """ # noqa: E501
    type: StrictStr
    data: ClaimHookCreateClaimHookRequestHookAnyOf1Data
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": ClaimHookCreateClaimHookRequestHookAnyOf1Data.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
