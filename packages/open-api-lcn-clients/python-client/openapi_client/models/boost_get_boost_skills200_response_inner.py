...
class BoostGetBoostSkills200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "statement", "description", "code", "icon", "type", "status", "frameworkId", "createdAt", "updatedAt", "proficiencyLevel"]
