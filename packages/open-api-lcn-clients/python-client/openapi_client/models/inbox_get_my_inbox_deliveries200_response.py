...
class InboxGetMyInboxDeliveries200Response(BaseModel):
    """
    InboxGetMyInboxDeliveries200Response
    """ # noqa: E501
    records: List[InboxGetMyInboxDeliveries200ResponseRecordsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [InboxGetMyInboxDeliveries200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
