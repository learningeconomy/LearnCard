...
class InboxGetMyInboxDeliveries200ResponseRecordsInner(BaseModel):
    """
    InboxGetMyInboxDeliveries200ResponseRecordsInner
    """ # noqa: E501
    id: Optional[StrictStr]
    credential: InboxGetMyInboxDeliveries200ResponseRecordsInnerCredential
    expires_at: Optional[StrictStr] = Field(alias="expiresAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "credential", "expiresAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "credential": InboxGetMyInboxDeliveries200ResponseRecordsInnerCredential.from_dict(obj["credential"]) if obj.get("credential") is not None else None,
