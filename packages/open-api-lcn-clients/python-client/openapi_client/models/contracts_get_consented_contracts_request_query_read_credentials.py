...
class ContractsGetConsentedContractsRequestQueryReadCredentials(BaseModel):
    """
    ...
    categories: Optional[Dict[str, Optional[ContractsGetConsentedContractsRequestQueryReadCredentialsCategoriesValue]]] = None
