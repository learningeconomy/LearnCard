...
class SkillsGetSkill200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "statement", "description", "code", "icon", "type", "status", "frameworkId", "createdAt", "updatedAt"]
