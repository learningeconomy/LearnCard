...
class BoostUpdateOtherBoostPermissionsRequestUpdates(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["canView", "canEdit", "canIssue", "canRevoke", "canManagePermissions", "canIssueChildren", "canCreateChildren", "canEditChildren", "canRevokeChildren", "canManageChildrenPermissions", "canManageChildrenProfiles", "canViewAnalytics"]
