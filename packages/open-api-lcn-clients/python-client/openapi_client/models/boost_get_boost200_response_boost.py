...
class BoostGetBoost200ResponseBoost(BaseModel):
    """
    ...
    issuer: BoostGetBoost200ResponseBoostIssuer
    ...
    render_method: Optional[BoostGetBoost200ResponseBoostRenderMethod] = Field(default=None, alias="renderMethod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "type": obj.get("type"),
            "issuer": BoostGetBoost200ResponseBoostIssuer.from_dict(obj["issuer"]) if obj.get("issuer") is not None else None,
