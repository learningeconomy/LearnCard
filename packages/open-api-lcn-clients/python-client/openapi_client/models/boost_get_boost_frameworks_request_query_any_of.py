...
class BoostGetBoostFrameworksRequestQueryAnyOf(BaseModel):
    """
    BoostGetBoostFrameworksRequestQueryAnyOf
    """ # noqa: E501
    var_or: List[BoostGetBoostFrameworksRequestQueryAnyOfOrInner] = Field(alias="$or")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoostGetBoostFrameworksRequestQueryAnyOf from a JSON string"""
