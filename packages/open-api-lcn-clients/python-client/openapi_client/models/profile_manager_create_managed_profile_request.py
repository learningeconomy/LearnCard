...
class ProfileManagerCreateManagedProfileRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["profileId", "displayName", "shortBio", "bio", "isPrivate", "email", "image", "heroImage", "websiteLink", "isServiceProfile", "type", "notificationsWebhook", "display"]
