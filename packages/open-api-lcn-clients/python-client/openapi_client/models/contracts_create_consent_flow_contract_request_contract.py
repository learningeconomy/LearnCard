...
class ContractsCreateConsentFlowContractRequestContract(BaseModel):
    """
    ContractsCreateConsentFlowContractRequestContract
    """ # noqa: E501
    read: Optional[ContractsCreateConsentFlowContractRequestContractRead] = None
    write: Optional[ContractsCreateConsentFlowContractRequestContractWrite] = None
