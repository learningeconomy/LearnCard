...
class BoostSendRequestTemplateCredentialAnyOfIssuerAnyOfAddress(BaseModel):
    """
    ...
    geo: Optional[BoostSendRequestTemplateCredentialAnyOfIssuerAnyOfAddressGeo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "geo": BoostSendRequestTemplateCredentialAnyOfIssuerAnyOfAddressGeo.from_dict(obj["geo"]) if obj.get("geo") is not None else None
        })
        return _obj
