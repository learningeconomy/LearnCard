...
class ContractsGetConsentFlowContract200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contract", "owner", "name", "subtitle", "description", "reasonForAccessing", "image", "uri", "needsGuardianConsent", "redirectUrl", "frontDoorBoostUri", "createdAt", "updatedAt", "expiresAt", "autoBoosts"]
