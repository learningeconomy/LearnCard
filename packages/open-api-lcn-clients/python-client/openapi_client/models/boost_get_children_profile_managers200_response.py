...
class BoostGetChildrenProfileManagers200Response(BaseModel):
    """
    BoostGetChildrenProfileManagers200Response
    """ # noqa: E501
    cursor: Optional[StrictStr] = None
    has_more: StrictBool = Field(alias="hasMore")
    records: List[BoostGetChildrenProfileManagers200ResponseRecordsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [BoostGetChildrenProfileManagers200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
