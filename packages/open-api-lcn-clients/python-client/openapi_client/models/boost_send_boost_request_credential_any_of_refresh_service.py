...
class BoostSendBoostRequestCredentialAnyOfRefreshService(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = BoostSendBoostRequestCredentialAnyOfRefreshService.model_construct()
        error_messages = []
        # validate data type: BoostSendBoostRequestCredentialAnyOfRefreshServiceAnyOf
        if not isinstance(v, BoostSendBoostRequestCredentialAnyOfRefreshServiceAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BoostSendBoostRequestCredentialAnyOfRefreshServiceAnyOf`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[BoostSendBoostRequestCredentialAnyOfRefreshServiceAnyOf] = None
        try:
            instance.actual_instance = BoostSendBoostRequestCredentialAnyOfRefreshServiceAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
