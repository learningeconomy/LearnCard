...
class ContractsGetConsentedDataForDid200ResponseRecordsInnerGuardianApproval(BaseModel):
    """
    ContractsGetConsentedDataForDid200ResponseRecordsInnerGuardianApproval
    """ # noqa: E501
    guardian_profile_id: StrictStr = Field(alias="guardianProfileId")
    guardian_did: StrictStr = Field(alias="guardianDid")
    approved_at: datetime = Field(alias="approvedAt")
    contract_updated_at: StrictStr = Field(alias="contractUpdatedAt")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContractsGetConsentedDataForDid200ResponseRecordsInnerGuardianApproval from a JSON string"""
