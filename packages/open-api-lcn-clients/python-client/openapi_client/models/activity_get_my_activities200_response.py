...
class ActivityGetMyActivities200Response(BaseModel):
    """
    ActivityGetMyActivities200Response
    """ # noqa: E501
    records: List[ActivityGetMyActivities200ResponseRecordsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [ActivityGetMyActivities200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
