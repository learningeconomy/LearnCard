...
class AppStoreUpdateListingRequest(BaseModel):
    """
    AppStoreUpdateListingRequest
    """ # noqa: E501
    updates: AppStoreUpdateListingRequestUpdates
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": AppStoreUpdateListingRequestUpdates.from_dict(obj["updates"]) if obj.get("updates") is not None else None
        })
        return _obj
