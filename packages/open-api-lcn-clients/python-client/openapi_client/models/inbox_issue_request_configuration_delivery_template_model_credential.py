...
class InboxIssueRequestConfigurationDeliveryTemplateModelCredential(BaseModel):
    """
    InboxIssueRequestConfigurationDeliveryTemplateModelCredential
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the credential (e.g., \"Bachelor of Science\").")
    type: Optional[StrictStr] = Field(default=None, description="The type of the credential (e.g., \"degree\", \"certificate\").")
