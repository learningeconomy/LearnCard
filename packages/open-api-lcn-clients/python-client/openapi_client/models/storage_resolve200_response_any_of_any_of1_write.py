...
class StorageResolve200ResponseAnyOfAnyOf1Write(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageResolve200ResponseAnyOfAnyOf1Write from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageResolve200ResponseAnyOfAnyOf1Write from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "credentials": StorageResolve200ResponseAnyOfAnyOf1WriteCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "personal": dict(
