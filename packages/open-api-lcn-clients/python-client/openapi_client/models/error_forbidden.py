...
class ErrorFORBIDDEN(BaseModel):
    ...
    """ # noqa: E501
    message: StrictStr = Field(description="The error message", json_schema_extra={"examples": ["Insufficient access"]})
    code: StrictStr = Field(description="The error code", json_schema_extra={"examples": ["FORBIDDEN"]})
