...
class BoostGetBoostAdmins200Response(BaseModel):
    """
    BoostGetBoostAdmins200Response
    """ # noqa: E501
    cursor: Optional[StrictStr] = None
    has_more: StrictBool = Field(alias="hasMore")
    records: List[BoostGetPaginatedBoostRecipients200ResponseRecordsInnerTo]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [BoostGetPaginatedBoostRecipients200ResponseRecordsInnerTo.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
