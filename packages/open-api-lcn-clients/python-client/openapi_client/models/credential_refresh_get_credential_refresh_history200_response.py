...
class CredentialRefreshGetCredentialRefreshHistory200Response(BaseModel):
    """
    CredentialRefreshGetCredentialRefreshHistory200Response
    """ # noqa: E501
    records: List[CredentialRefreshGetCredentialRefreshHistory200ResponseRecordsInner]
    has_more: StrictBool = Field(alias="hasMore")
    cursor: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["records", "hasMore", "cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [CredentialRefreshGetCredentialRefreshHistory200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
