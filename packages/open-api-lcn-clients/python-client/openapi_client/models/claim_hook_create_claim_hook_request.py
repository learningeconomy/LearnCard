...
class ClaimHookCreateClaimHookRequest(BaseModel):
    """
    ClaimHookCreateClaimHookRequest
    """ # noqa: E501
    hook: ClaimHookCreateClaimHookRequestHook
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hook": ClaimHookCreateClaimHookRequestHook.from_dict(obj["hook"]) if obj.get("hook") is not None else None
        })
        return _obj
