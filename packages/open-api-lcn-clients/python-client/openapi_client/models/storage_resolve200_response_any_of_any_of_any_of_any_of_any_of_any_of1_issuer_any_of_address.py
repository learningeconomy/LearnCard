...
class StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfAddress(BaseModel):
    """
    ...
    geo: Optional[StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfAddressGeo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "geo": StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfAddressGeo.from_dict(obj["geo"]) if obj.get("geo") is not None else None
        })
        return _obj
