...
class StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOf(BaseModel):
    """
    ...
    image: Optional[StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfImage] = None
    email: Optional[Annotated[str, Field(strict=True)]] = None
    address: Optional[StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfAddress] = None
    other_identifier: Optional[List[StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfOtherIdentifierInner]] = Field(default=None, alias="otherIdentifier")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOf from a JSON string"""
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.other_identifier:
            for _item_other_identifier in self.other_identifier:
                _items.append(_item_other_identifier.to_dict() if _item_other_identifier is not None else None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "image": StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "email": obj.get("email"),
            "address": StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "otherIdentifier": [StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfAnyOf1IssuerAnyOfOtherIdentifierInner.from_dict(_item) for _item in obj["otherIdentifier"]] if obj.get("otherIdentifier") is not None else None,
