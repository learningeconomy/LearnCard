...
INBOXISSUEREQUESTCREDENTIAL_ANY_OF_SCHEMAS = ["BoostCreateBoostRequestCredentialAnyOf", "InboxIssueRequestCredentialAnyOf"]

class InboxIssueRequestCredential(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = InboxIssueRequestCredential.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in InboxIssueRequestCredential with anyOf schemas: BoostCreateBoostRequestCredentialAnyOf, InboxIssueRequestCredentialAnyOf. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into InboxIssueRequestCredential with anyOf schemas: BoostCreateBoostRequestCredentialAnyOf, InboxIssueRequestCredentialAnyOf. Details: " + ", ".join(error_messages))
        else:
            return instance
