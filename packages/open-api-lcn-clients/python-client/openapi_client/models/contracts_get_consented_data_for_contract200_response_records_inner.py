...
class ContractsGetConsentedDataForContract200ResponseRecordsInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credentials": ContractsGetConsentedDataForContract200ResponseRecordsInnerCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
