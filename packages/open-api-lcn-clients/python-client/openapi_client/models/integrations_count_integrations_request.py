...
class IntegrationsCountIntegrationsRequest(BaseModel):
    """
    IntegrationsCountIntegrationsRequest
    """ # noqa: E501
    query: Optional[IntegrationsGetIntegrationsRequestQuery] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": IntegrationsGetIntegrationsRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
