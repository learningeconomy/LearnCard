...
class AppStoreGetMyCredentialsFromApp200Response(BaseModel):
    """
    AppStoreGetMyCredentialsFromApp200Response
    """ # noqa: E501
    has_more: StrictBool = Field(alias="hasMore")
    cursor: Optional[StrictStr] = None
    records: List[AppStoreGetMyCredentialsFromApp200ResponseRecordsInner]
    total_count: Optional[Union[StrictFloat, StrictInt]] = Field(alias="totalCount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["hasMore", "cursor", "records", "totalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [AppStoreGetMyCredentialsFromApp200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
