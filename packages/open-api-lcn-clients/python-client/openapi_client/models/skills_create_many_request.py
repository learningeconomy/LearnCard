...
class SkillsCreateManyRequest(BaseModel):
    """
    SkillsCreateManyRequest
    """ # noqa: E501
    framework_id: StrictStr = Field(alias="frameworkId")
    skills: Annotated[List[SkillTreeNodeInput], Field(min_length=1)]
    parent_id: Optional[StrictStr] = Field(default=None, alias="parentId")
    __properties: ClassVar[List[str]] = ["frameworkId", "skills", "parentId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skills": [SkillTreeNodeInput.from_dict(_item) for _item in obj["skills"]] if obj.get("skills") is not None else None,
