...
class InboxGetGuardianPendingCredential200ResponseIssuer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["displayName", "profileId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InboxGetGuardianPendingCredential200ResponseIssuer from a JSON string"""
