...
class CredentialRefreshSendRefreshableCredentialRequest(BaseModel):
    """
    ...
    credential: BoostSendRequestTemplateCredentialAnyOf
    boost_uri: Optional[StrictStr] = Field(default=None, alias="boostUri")
    skip_notification: Optional[StrictBool] = Field(default=None, alias="skipNotification")
    __properties: ClassVar[List[str]] = ["refreshId", "credential", "boostUri", "skipNotification"]
