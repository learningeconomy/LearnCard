...
class ContractsDeleteCredentialFromAllContractsRequest(BaseModel):
    """
    ContractsDeleteCredentialFromAllContractsRequest
    """ # noqa: E501
    deleted_uris: Annotated[List[StrictStr], Field(min_length=1)] = Field(alias="deletedUris")
    __properties: ClassVar[List[str]] = ["deletedUris"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deletedUris": obj.get("deletedUris")
        })
        return _obj
