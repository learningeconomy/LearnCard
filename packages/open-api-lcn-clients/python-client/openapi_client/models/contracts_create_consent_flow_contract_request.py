...
class ContractsCreateConsentFlowContractRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contract", "name", "subtitle", "description", "reasonForAccessing", "needsGuardianConsent", "redirectUrl", "frontDoorBoostUri", "image", "expiresAt", "autoboosts"]
