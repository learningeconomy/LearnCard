...
class SkillsSyncFrameworkSkills200Response(BaseModel):
    """
    SkillsSyncFrameworkSkills200Response
    """ # noqa: E501
    framework: BoostGetBoostFrameworks200ResponseRecordsInner
    skills: SkillsGetFrameworkSkillTree200Response
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skills": SkillsGetFrameworkSkillTree200Response.from_dict(obj["skills"]) if obj.get("skills") is not None else None
        })
