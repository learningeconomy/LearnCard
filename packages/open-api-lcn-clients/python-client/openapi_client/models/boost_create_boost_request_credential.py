...
BOOSTCREATEBOOSTREQUESTCREDENTIAL_ANY_OF_SCHEMAS = ["BoostCreateBoostRequestCredentialAnyOf", "BoostSendRequestTemplateCredentialAnyOf"]

class BoostCreateBoostRequestCredential(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = BoostCreateBoostRequestCredential.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in BoostCreateBoostRequestCredential with anyOf schemas: BoostCreateBoostRequestCredentialAnyOf, BoostSendRequestTemplateCredentialAnyOf. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into BoostCreateBoostRequestCredential with anyOf schemas: BoostCreateBoostRequestCredentialAnyOf, BoostSendRequestTemplateCredentialAnyOf. Details: " + ", ".join(error_messages))
        else:
            return instance
