...
class ContractsGetConsentFlowContractsRequestQuery(BaseModel):
    """
    ContractsGetConsentFlowContractsRequestQuery
    """ # noqa: E501
    read: Optional[ContractsGetConsentFlowContractsRequestQueryRead] = None
    write: Optional[ContractsGetConsentFlowContractsRequestQueryWrite] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read": ContractsGetConsentFlowContractsRequestQueryRead.from_dict(obj["read"]) if obj.get("read") is not None else None,
            "write": ContractsGetConsentFlowContractsRequestQueryWrite.from_dict(obj["write"]) if obj.get("write") is not None else None
        })
        return _obj
