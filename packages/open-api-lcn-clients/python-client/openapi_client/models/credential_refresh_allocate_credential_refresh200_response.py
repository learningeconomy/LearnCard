...
class CredentialRefreshAllocateCredentialRefresh200Response(BaseModel):
    """
    ...
    refresh_service: CredentialRefreshAllocateCredentialRefresh200ResponseRefreshService = Field(alias="refreshService")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["refreshId", "refreshService"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refreshService": CredentialRefreshAllocateCredentialRefresh200ResponseRefreshService.from_dict(obj["refreshService"]) if obj.get("refreshService") is not None else None
        })
