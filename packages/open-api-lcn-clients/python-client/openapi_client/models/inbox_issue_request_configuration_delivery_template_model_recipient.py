...
class InboxIssueRequestConfigurationDeliveryTemplateModelRecipient(BaseModel):
    """
    InboxIssueRequestConfigurationDeliveryTemplateModelRecipient
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the recipient (e.g., \"John Doe\").")
