...
class BoostGetBoostsRequestQueryAnyOf(BaseModel):
    """
    BoostGetBoostsRequestQueryAnyOf
    """ # noqa: E501
    var_or: List[BoostGetBoostsRequestQueryAnyOfOrInner] = Field(alias="$or")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoostGetBoostsRequestQueryAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$or": [BoostGetBoostsRequestQueryAnyOfOrInner.from_dict(_item) for _item in obj["$or"]] if obj.get("$or") is not None else None
        })
        return _obj
