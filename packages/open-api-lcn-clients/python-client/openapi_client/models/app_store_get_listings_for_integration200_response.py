...
class AppStoreGetListingsForIntegration200Response(BaseModel):
    """
    AppStoreGetListingsForIntegration200Response
    """ # noqa: E501
    has_more: StrictBool = Field(alias="hasMore")
    cursor: Optional[StrictStr] = None
    records: List[AppStoreGetListingsForIntegration200ResponseRecordsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [AppStoreGetListingsForIntegration200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
