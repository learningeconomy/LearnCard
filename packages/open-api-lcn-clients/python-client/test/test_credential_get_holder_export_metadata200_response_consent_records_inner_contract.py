...
class TestCredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract(unittest.TestCase):
    """CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract:
        """Test CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract`
        """
        model = CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract()
        if include_optional:
            return CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract(
    ...
    def testCredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract(self):
        """Test CredentialGetHolderExportMetadata200ResponseConsentRecordsInnerContract"""
