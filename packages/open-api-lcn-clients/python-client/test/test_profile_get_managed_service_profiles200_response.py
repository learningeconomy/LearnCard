...
class TestProfileGetManagedServiceProfiles200Response(unittest.TestCase):
    """ProfileGetManagedServiceProfiles200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileGetManagedServiceProfiles200Response:
        """Test ProfileGetManagedServiceProfiles200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileGetManagedServiceProfiles200Response`
        """
        model = ProfileGetManagedServiceProfiles200Response()
        if include_optional:
            return ProfileGetManagedServiceProfiles200Response(
                cursor = '',
                has_more = True,
                records = [
    ...
    def testProfileGetManagedServiceProfiles200Response(self):
        """Test ProfileGetManagedServiceProfiles200Response"""
