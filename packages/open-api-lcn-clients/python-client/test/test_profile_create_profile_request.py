...
class TestProfileCreateProfileRequest(unittest.TestCase):
    """ProfileCreateProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileCreateProfileRequest:
        """Test ProfileCreateProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileCreateProfileRequest`
        """
        model = ProfileCreateProfileRequest()
        if include_optional:
    ...
    def testProfileCreateProfileRequest(self):
        """Test ProfileCreateProfileRequest"""
