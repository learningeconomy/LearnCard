...
class TestBoostGetBoostRecipients200ResponseInnerToAnyOf3(unittest.TestCase):
    """BoostGetBoostRecipients200ResponseInnerToAnyOf3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostGetBoostRecipients200ResponseInnerToAnyOf3:
        """Test BoostGetBoostRecipients200ResponseInnerToAnyOf3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostGetBoostRecipients200ResponseInnerToAnyOf3`
        """
        model = BoostGetBoostRecipients200ResponseInnerToAnyOf3()
        if include_optional:
            return BoostGetBoostRecipients200ResponseInnerToAnyOf3(
                profile_id = '012',
                display_name = '',
                short_bio = '',
                bio = '',
    ...
    def testBoostGetBoostRecipients200ResponseInnerToAnyOf3(self):
        """Test BoostGetBoostRecipients200ResponseInnerToAnyOf3"""
