...
class TestContractsCreateConsentFlowContractRequestContract(unittest.TestCase):
    """ContractsCreateConsentFlowContractRequestContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractsCreateConsentFlowContractRequestContract:
        """Test ContractsCreateConsentFlowContractRequestContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractsCreateConsentFlowContractRequestContract`
        """
        model = ContractsCreateConsentFlowContractRequestContract()
        if include_optional:
            return ContractsCreateConsentFlowContractRequestContract(
    ...
    def testContractsCreateConsentFlowContractRequestContract(self):
        """Test ContractsCreateConsentFlowContractRequestContract"""
