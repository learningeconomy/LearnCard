...
class TestInboxIssueRequestConfigurationDeliveryTemplateModel(unittest.TestCase):
    """InboxIssueRequestConfigurationDeliveryTemplateModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboxIssueRequestConfigurationDeliveryTemplateModel:
        """Test InboxIssueRequestConfigurationDeliveryTemplateModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboxIssueRequestConfigurationDeliveryTemplateModel`
        """
        model = InboxIssueRequestConfigurationDeliveryTemplateModel()
        if include_optional:
            return InboxIssueRequestConfigurationDeliveryTemplateModel(
    ...
    def testInboxIssueRequestConfigurationDeliveryTemplateModel(self):
        """Test InboxIssueRequestConfigurationDeliveryTemplateModel"""
