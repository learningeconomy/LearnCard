...
class TestBoostCountBoostChildrenRequest(unittest.TestCase):
    """BoostCountBoostChildrenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostCountBoostChildrenRequest:
        """Test BoostCountBoostChildrenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostCountBoostChildrenRequest`
        """
        model = BoostCountBoostChildrenRequest()
        if include_optional:
    ...
    def testBoostCountBoostChildrenRequest(self):
        """Test BoostCountBoostChildrenRequest"""
