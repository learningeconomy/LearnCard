...
class TestAppStoreCreateListingRequestListing(unittest.TestCase):
    """AppStoreCreateListingRequestListing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreCreateListingRequestListing:
        """Test AppStoreCreateListingRequestListing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreCreateListingRequestListing`
        """
        model = AppStoreCreateListingRequestListing()
        if include_optional:
            return AppStoreCreateListingRequestListing(
                display_name = '0',
                tagline = '0',
                full_description = '',
                icon_url = '',
    ...
    def testAppStoreCreateListingRequestListing(self):
        """Test AppStoreCreateListingRequestListing"""
