...
class TestCredentialSendCredentialRequestCredential(unittest.TestCase):
    """CredentialSendCredentialRequestCredential unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialSendCredentialRequestCredential:
        """Test CredentialSendCredentialRequestCredential
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialSendCredentialRequestCredential`
        """
        model = CredentialSendCredentialRequestCredential()
        if include_optional:
            return CredentialSendCredentialRequestCredential(
                context = [
                    null
                    ],
                id = '',
    ...
    def testCredentialSendCredentialRequestCredential(self):
        """Test CredentialSendCredentialRequestCredential"""
