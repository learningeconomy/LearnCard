...
class TestBoostGetBoost200ResponseBoostIssuerAnyOf(unittest.TestCase):
    """BoostGetBoost200ResponseBoostIssuerAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostGetBoost200ResponseBoostIssuerAnyOf:
        """Test BoostGetBoost200ResponseBoostIssuerAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostGetBoost200ResponseBoostIssuerAnyOf`
        """
        model = BoostGetBoost200ResponseBoostIssuerAnyOf()
        if include_optional:
            return BoostGetBoost200ResponseBoostIssuerAnyOf(
                id = '',
                type = None,
                name = '',
                url = '',
                ...
                address = openapi_client.models.boost_get_boost_200_response_boost_issuer_any_of_address.boost_getBoost_200_response_boost_issuer_anyOf_address(
                    type = null, 
                    address_country = '', 
                    ...
                    postal_code = '', 
                    geo = openapi_client.models.boost_get_boost_200_response_boost_issuer_any_of_address_geo.boost_getBoost_200_response_boost_issuer_anyOf_address_geo(
                        type = null, 
                        latitude = 1.337, 
                        longitude = 1.337, ), ),
                other_identifier = [
                    openapi_client.models.boost_get_boost_200_response_boost_issuer_any_of_other_identifier_inner.boost_getBoost_200_response_boost_issuer_anyOf_otherIdentifier_inner(
                        type = null, 
                        identifier = '', 
    ...
    def testBoostGetBoost200ResponseBoostIssuerAnyOf(self):
        """Test BoostGetBoost200ResponseBoostIssuerAnyOf"""
