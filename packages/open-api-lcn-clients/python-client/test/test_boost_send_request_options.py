...
class TestBoostSendRequestOptions(unittest.TestCase):
    """BoostSendRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostSendRequestOptions:
        """Test BoostSendRequestOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostSendRequestOptions`
        """
        model = BoostSendRequestOptions()
        if include_optional:
            return BoostSendRequestOptions(
                webhook_url = '',
    ...
    def testBoostSendRequestOptions(self):
        """Test BoostSendRequestOptions"""
