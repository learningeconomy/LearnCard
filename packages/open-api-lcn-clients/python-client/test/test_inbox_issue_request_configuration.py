...
class TestInboxIssueRequestConfiguration(unittest.TestCase):
    """InboxIssueRequestConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboxIssueRequestConfiguration:
        """Test InboxIssueRequestConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboxIssueRequestConfiguration`
        """
        model = InboxIssueRequestConfiguration()
        if include_optional:
            return InboxIssueRequestConfiguration(
    ...
    def testInboxIssueRequestConfiguration(self):
        """Test InboxIssueRequestConfiguration"""
