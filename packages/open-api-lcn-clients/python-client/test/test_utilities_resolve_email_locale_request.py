...
class TestUtilitiesResolveEmailLocaleRequest(unittest.TestCase):
    """UtilitiesResolveEmailLocaleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtilitiesResolveEmailLocaleRequest:
        """Test UtilitiesResolveEmailLocaleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtilitiesResolveEmailLocaleRequest`
        """
        model = UtilitiesResolveEmailLocaleRequest()
        if include_optional:
            return UtilitiesResolveEmailLocaleRequest(
    ...
    def testUtilitiesResolveEmailLocaleRequest(self):
        """Test UtilitiesResolveEmailLocaleRequest"""
