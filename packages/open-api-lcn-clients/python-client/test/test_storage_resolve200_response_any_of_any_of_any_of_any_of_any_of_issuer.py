...
class TestStorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer(unittest.TestCase):
    """StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer:
        """Test StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer`
        """
        model = StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer()
        if include_optional:
            return StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer(
                id = '',
                type = None,
                name = '',
                url = '',
    ...
    def testStorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer(self):
        """Test StorageResolve200ResponseAnyOfAnyOfAnyOfAnyOfAnyOfIssuer"""
