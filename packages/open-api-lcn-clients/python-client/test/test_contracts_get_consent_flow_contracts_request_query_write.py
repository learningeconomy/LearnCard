...
class TestContractsGetConsentFlowContractsRequestQueryWrite(unittest.TestCase):
    """ContractsGetConsentFlowContractsRequestQueryWrite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractsGetConsentFlowContractsRequestQueryWrite:
        """Test ContractsGetConsentFlowContractsRequestQueryWrite
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractsGetConsentFlowContractsRequestQueryWrite`
        """
    ...
    def testContractsGetConsentFlowContractsRequestQueryWrite(self):
        """Test ContractsGetConsentFlowContractsRequestQueryWrite"""
