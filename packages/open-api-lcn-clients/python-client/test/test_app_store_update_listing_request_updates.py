...
class TestAppStoreUpdateListingRequestUpdates(unittest.TestCase):
    """AppStoreUpdateListingRequestUpdates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreUpdateListingRequestUpdates:
        """Test AppStoreUpdateListingRequestUpdates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreUpdateListingRequestUpdates`
        """
        model = AppStoreUpdateListingRequestUpdates()
        if include_optional:
            return AppStoreUpdateListingRequestUpdates(
                display_name = '0',
                tagline = '0',
                full_description = '',
                icon_url = '',
    ...
    def testAppStoreUpdateListingRequestUpdates(self):
        """Test AppStoreUpdateListingRequestUpdates"""
