...
class TestProfileCreateServiceProfileRequest(unittest.TestCase):
    """ProfileCreateServiceProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileCreateServiceProfileRequest:
        """Test ProfileCreateServiceProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileCreateServiceProfileRequest`
        """
        model = ProfileCreateServiceProfileRequest()
        if include_optional:
            return ProfileCreateServiceProfileRequest(
                profile_id = '012',
                display_name = '',
                short_bio = '',
                bio = '',
    ...
    def testProfileCreateServiceProfileRequest(self):
        """Test ProfileCreateServiceProfileRequest"""
