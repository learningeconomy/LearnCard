...
class TestBoostGetBoost200ResponseBoostIssuer(unittest.TestCase):
    """BoostGetBoost200ResponseBoostIssuer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostGetBoost200ResponseBoostIssuer:
        """Test BoostGetBoost200ResponseBoostIssuer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostGetBoost200ResponseBoostIssuer`
        """
        model = BoostGetBoost200ResponseBoostIssuer()
        if include_optional:
            return BoostGetBoost200ResponseBoostIssuer(
                id = '',
                type = None,
                name = '',
                url = '',
    ...
    def testBoostGetBoost200ResponseBoostIssuer(self):
        """Test BoostGetBoost200ResponseBoostIssuer"""
