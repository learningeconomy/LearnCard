...
class TestAppStoreCreateListingRequest(unittest.TestCase):
    """AppStoreCreateListingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreCreateListingRequest:
        """Test AppStoreCreateListingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreCreateListingRequest`
        """
        model = AppStoreCreateListingRequest()
        if include_optional:
            return AppStoreCreateListingRequest(
                integration_id = '',
                listing = openapi_client.models.app_store_create_listing_request_listing.appStore_createListing_request_listing(
                    display_name = '0', 
                    tagline = '0', 
                    full_description = '', 
                    icon_url = '', 
    ...
    def testAppStoreCreateListingRequest(self):
        """Test AppStoreCreateListingRequest"""
