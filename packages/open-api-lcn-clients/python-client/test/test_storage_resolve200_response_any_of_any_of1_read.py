...
class TestStorageResolve200ResponseAnyOfAnyOf1Read(unittest.TestCase):
    """StorageResolve200ResponseAnyOfAnyOf1Read unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageResolve200ResponseAnyOfAnyOf1Read:
        """Test StorageResolve200ResponseAnyOfAnyOf1Read
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageResolve200ResponseAnyOfAnyOf1Read`
        """
        model = StorageResolve200ResponseAnyOfAnyOf1Read()
        if include_optional:
    ...
    def testStorageResolve200ResponseAnyOfAnyOf1Read(self):
        """Test StorageResolve200ResponseAnyOfAnyOf1Read"""
