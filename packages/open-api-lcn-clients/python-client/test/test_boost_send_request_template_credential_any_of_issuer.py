...
class TestBoostSendRequestTemplateCredentialAnyOfIssuer(unittest.TestCase):
    """BoostSendRequestTemplateCredentialAnyOfIssuer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostSendRequestTemplateCredentialAnyOfIssuer:
        """Test BoostSendRequestTemplateCredentialAnyOfIssuer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostSendRequestTemplateCredentialAnyOfIssuer`
        """
        model = BoostSendRequestTemplateCredentialAnyOfIssuer()
        if include_optional:
            return BoostSendRequestTemplateCredentialAnyOfIssuer(
                id = '',
                type = None,
                name = '',
                url = '',
    ...
    def testBoostSendRequestTemplateCredentialAnyOfIssuer(self):
        """Test BoostSendRequestTemplateCredentialAnyOfIssuer"""
