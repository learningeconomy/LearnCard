...
class TestInboxIssueRequestRecipientOneOf(unittest.TestCase):
    """InboxIssueRequestRecipientOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboxIssueRequestRecipientOneOf:
        """Test InboxIssueRequestRecipientOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboxIssueRequestRecipientOneOf`
        """
        model = InboxIssueRequestRecipientOneOf()
        if include_optional:
            return InboxIssueRequestRecipientOneOf(
                type = 'email',
    ...
    def testInboxIssueRequestRecipientOneOf(self):
        """Test InboxIssueRequestRecipientOneOf"""
