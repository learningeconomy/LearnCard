...
class TestContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms(unittest.TestCase):
    """ContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms:
        """Test ContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms`
        """
        model = ContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms()
        if include_optional:
            return ContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms(
    ...
    def testContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms(self):
        """Test ContractsGetTermsTransactionHistory200ResponseRecordsInnerTerms"""
