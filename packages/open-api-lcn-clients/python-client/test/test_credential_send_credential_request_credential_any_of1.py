...
class TestCredentialSendCredentialRequestCredentialAnyOf1(unittest.TestCase):
    """CredentialSendCredentialRequestCredentialAnyOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialSendCredentialRequestCredentialAnyOf1:
        """Test CredentialSendCredentialRequestCredentialAnyOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialSendCredentialRequestCredentialAnyOf1`
        """
        model = CredentialSendCredentialRequestCredentialAnyOf1()
        if include_optional:
            return CredentialSendCredentialRequestCredentialAnyOf1(
                protected = '',
                iv = '',
                ciphertext = '',
                tag = '',
    ...
    def testCredentialSendCredentialRequestCredentialAnyOf1(self):
        """Test CredentialSendCredentialRequestCredentialAnyOf1"""
