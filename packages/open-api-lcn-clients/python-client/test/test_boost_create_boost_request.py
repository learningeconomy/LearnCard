...
class TestBoostCreateBoostRequest(unittest.TestCase):
    """BoostCreateBoostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostCreateBoostRequest:
        """Test BoostCreateBoostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostCreateBoostRequest`
        """
        model = BoostCreateBoostRequest()
        if include_optional:
    ...
    def testBoostCreateBoostRequest(self):
        """Test BoostCreateBoostRequest"""
