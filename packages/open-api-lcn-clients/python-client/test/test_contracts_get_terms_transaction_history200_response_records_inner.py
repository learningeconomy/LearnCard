    ...
    def make_instance(self, include_optional) -> ContractsGetTermsTransactionHistory200ResponseRecordsInner:
        ...
        if include_optional:
            return ContractsGetTermsTransactionHistory200ResponseRecordsInner(
                ...
                guardian_approval = openapi_client.models.contracts_get_consented_data_for_did_200_response_records_inner_guardian_approval.contracts_getConsentedDataForDid_200_response_records_inner_guardian_approval(
                    guardian_profile_id = '', 
                    guardian_did = '', 
