...
class TestInboxIssueRequest(unittest.TestCase):
    """InboxIssueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboxIssueRequest:
        """Test InboxIssueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboxIssueRequest`
        """
    ...
    def testInboxIssueRequest(self):
        """Test InboxIssueRequest"""
