...
class TestProfileSearchProfiles200ResponseInner(unittest.TestCase):
    """ProfileSearchProfiles200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileSearchProfiles200ResponseInner:
        """Test ProfileSearchProfiles200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileSearchProfiles200ResponseInner`
        """
        model = ProfileSearchProfiles200ResponseInner()
        if include_optional:
            return ProfileSearchProfiles200ResponseInner(
                profile_id = '012',
                display_name = '',
                short_bio = '',
                bio = '',
    ...
    def testProfileSearchProfiles200ResponseInner(self):
        """Test ProfileSearchProfiles200ResponseInner"""
