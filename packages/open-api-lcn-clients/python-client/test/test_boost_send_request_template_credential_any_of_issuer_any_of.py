...
class TestBoostSendRequestTemplateCredentialAnyOfIssuerAnyOf(unittest.TestCase):
    """BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf:
        """Test BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf`
        """
        model = BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf()
        if include_optional:
            return BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf(
                id = '',
                type = None,
                name = '',
                url = '',
                ...
                address = openapi_client.models.boost_send_request_template_credential_any_of_issuer_any_of_address.boost_send_request_template_credential_anyOf_issuer_anyOf_address(
                    ...
                    geo = openapi_client.models.boost_send_request_template_credential_any_of_issuer_any_of_address_geo.boost_send_request_template_credential_anyOf_issuer_anyOf_address_geo(
                        ...
                        longitude = 1.337, ), ),
                other_identifier = [
                    openapi_client.models.boost_send_request_template_credential_any_of_issuer_any_of_other_identifier_inner.boost_send_request_template_credential_anyOf_issuer_anyOf_otherIdentifier_inner(
                        type = null, 
                        identifier = '', 
    ...
    def testBoostSendRequestTemplateCredentialAnyOfIssuerAnyOf(self):
        """Test BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf"""
