...
json = "{}"
# create an instance of BoostGetBoostRecipients200ResponseInnerToAnyOf3 from a JSON string
boost_get_boost_recipients200_response_inner_to_any_of3_instance = BoostGetBoostRecipients200ResponseInnerToAnyOf3.from_json(json)
# print the JSON string representation of the object
print(BoostGetBoostRecipients200ResponseInnerToAnyOf3.to_json())

# convert the object into a dict
boost_get_boost_recipients200_response_inner_to_any_of3_dict = boost_get_boost_recipients200_response_inner_to_any_of3_instance.to_dict()
# create an instance of BoostGetBoostRecipients200ResponseInnerToAnyOf3 from a dict
boost_get_boost_recipients200_response_inner_to_any_of3_from_dict = BoostGetBoostRecipients200ResponseInnerToAnyOf3.from_dict(boost_get_boost_recipients200_response_inner_to_any_of3_dict)
```
