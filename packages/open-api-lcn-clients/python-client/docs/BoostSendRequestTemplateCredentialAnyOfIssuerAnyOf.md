...
json = "{}"
# create an instance of BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf from a JSON string
boost_send_request_template_credential_any_of_issuer_any_of_instance = BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf.from_json(json)
# print the JSON string representation of the object
print(BoostSendRequestTemplateCredentialAnyOfIssuerAnyOf.to_json())

# convert the object into a dict
boost_send_request_template_credential_any_of_issuer_any_of_dict = boost_send_request_template_credential_any_of_issuer_any_of_instance.to_dict()
