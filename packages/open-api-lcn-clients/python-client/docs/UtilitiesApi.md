...
```python
import openapi_client
from openapi_client.models.utilities_resolve_email_locale200_response import UtilitiesResolveEmailLocale200Response
from openapi_client.models.utilities_resolve_email_locale_request import UtilitiesResolveEmailLocaleRequest
from openapi_client.rest import ApiException
from pprint import pprint
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Resolve a recipient locale by email
        api_response = api_instance.utilities_resolve_email_locale(utilities_resolve_email_locale_request)
        print("The response of UtilitiesApi->utilities_resolve_email_locale:\n")
        pprint(api_response)
    except Exception as e:
...
[**UtilitiesResolveEmailLocale200Response**](UtilitiesResolveEmailLocale200Response.md)
