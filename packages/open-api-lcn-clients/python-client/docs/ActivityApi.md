...
> ActivityGetActivityStats200Response activity_get_activity_stats(boost_uris=boost_uris, integration_id=integration_id, event_type=event_type, start_date=start_date, end_date=end_date)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Credential Activity Stats
        api_response = api_instance.activity_get_activity_stats(boost_uris=boost_uris, integration_id=integration_id, event_type=event_type, start_date=start_date, end_date=end_date)
...
> ActivityGetMyActivities200Response activity_get_my_activities(limit=limit, cursor=cursor, boost_uri=boost_uri, event_type=event_type, integration_id=integration_id, start_date=start_date, end_date=end_date, group_by_latest_status=group_by_latest_status)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Credential Activities
        api_response = api_instance.activity_get_my_activities(limit=limit, cursor=cursor, boost_uri=boost_uri, event_type=event_type, integration_id=integration_id, start_date=start_date, end_date=end_date, group_by_latest_status=group_by_latest_status)
