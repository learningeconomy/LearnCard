...
> BoostGetSkillsAvailableForBoost200ResponseInnerFramework skill_frameworks_create(skill_frameworks_create_request)
...
[**BoostGetSkillsAvailableForBoost200ResponseInnerFramework**](BoostGetSkillsAvailableForBoost200ResponseInnerFramework.md)
...
> BoostGetSkillsAvailableForBoost200ResponseInnerFramework skill_frameworks_create_managed(skill_frameworks_create_managed_request)
...
> List[BoostGetSkillsAvailableForBoost200ResponseInnerFramework] skill_frameworks_create_managed_batch(skill_frameworks_create_managed_batch_request)
...
[**List[BoostGetSkillsAvailableForBoost200ResponseInnerFramework]**](BoostGetSkillsAvailableForBoost200ResponseInnerFramework.md)
...
> SkillFrameworksAddFrameworkAdmin200Response skill_frameworks_delete(id)
...
> List[BoostGetBoostRecipients200ResponseInnerTo] skill_frameworks_list_framework_admins(framework_id)
...
> List[BoostGetSkillsAvailableForBoost200ResponseInnerFramework] skill_frameworks_list_mine()
...
> SkillFrameworksAddFrameworkAdmin200Response skill_frameworks_remove_framework_admin(framework_id, profile_id)
...
> BoostGetSkillsAvailableForBoost200ResponseInnerFramework skill_frameworks_update(id, skill_frameworks_update_request)
...
> List[SkillsListSkillTags200ResponseInner] skills_add_skill_tag(id, skills_add_skill_tag_request)
...
# **skills_create**
> SkillsGetSkill200Response skills_create(skills_create_request)
...
# **skills_create_many**
> List[SkillsGetSkill200Response] skills_create_many(skills_create_many_request)
...
[**List[SkillsGetSkill200Response]**](SkillsGetSkill200Response.md)
...
> SkillFrameworksGetById200ResponseSkills skills_get_framework_skill_tree(id, roots_limit=roots_limit, children_limit=children_limit, cursor=cursor)
...
[**SkillFrameworksGetById200ResponseSkills**](SkillFrameworksGetById200ResponseSkills.md)
...
> SkillFrameworksGetById200ResponseSkills skills_get_skill_children_tree(id, framework_id, limit=limit, cursor=cursor)
...
> SkillFrameworksAddFrameworkAdmin200Response skills_remove_skill_tag(id, slug, framework_id)
...
> SkillFrameworksGetById200Response skills_sync_framework_skills(id)
