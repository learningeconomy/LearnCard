...
json = "{}"
# create an instance of SkillsCreate200Response from a JSON string
skills_create200_response_instance = SkillsCreate200Response.from_json(json)
# print the JSON string representation of the object
print(SkillsCreate200Response.to_json())

# convert the object into a dict
skills_create200_response_dict = skills_create200_response_instance.to_dict()
