...
json = "{}"
# create an instance of BoostSendBoostRequestCredentialAnyOf from a JSON string
boost_send_boost_request_credential_any_of_instance = BoostSendBoostRequestCredentialAnyOf.from_json(json)
# print the JSON string representation of the object
print(BoostSendBoostRequestCredentialAnyOf.to_json())

# convert the object into a dict
boost_send_boost_request_credential_any_of_dict = boost_send_boost_request_credential_any_of_instance.to_dict()
