...
import { UnsignedVCValidator as UnsignedVCValidator2 } from "@learncard/types";
var vcV1WithStatus = {
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedVCValidator2,
  credential: {
    "@context": [
...
import { UnsignedVCValidator as UnsignedVCValidator3 } from "@learncard/types";
var vcV2Basic = {
  id: "vc-v2/basic",
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedVCValidator3,
  credential: {
...
import { UnsignedVCValidator as UnsignedVCValidator4 } from "@learncard/types";
var vcV2WithEvidence = {
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedVCValidator4,
  credential: {
    "@context": ["https://www.w3.org/ns/credentials/v2"],
...
import { UnsignedVCValidator as UnsignedVCValidator5 } from "@learncard/types";
var vcV2MultipleSubjects = {
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedVCValidator5,
  tags: ["edge-case"],
  credential: {
    "@context": ["https://www.w3.org/ns/credentials/v2"],
...
import { UnsignedAchievementCredentialValidator as UnsignedAchievementCredentialValidator2 } from "@learncard/types";
var obv3FullBadge = {
  id: "obv3/full-badge",
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedAchievementCredentialValidator2,
  tags: ["comprehensive"],
  credential: {
    "@context": [
      "https://www.w3.org/ns/credentials/v2",
...
import { UnsignedAchievementCredentialValidator as UnsignedAchievementCredentialValidator3 } from "@learncard/types";
var obv3WithAlignment = {
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedAchievementCredentialValidator3,
  credential: {
    "@context": [
      "https://www.w3.org/ns/credentials/v2",
      "https://purl.imsglobal.org/spec/ob/v3p0/context-3.0.3.json"
...
import { UnsignedAchievementCredentialValidator as UnsignedAchievementCredentialValidator4 } from "@learncard/types";
var obv3WithEndorsement = {
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedAchievementCredentialValidator4,
  credential: {
    "@context": [
      "https://www.w3.org/ns/credentials/v2",
      "https://purl.imsglobal.org/spec/ob/v3p0/context-3.0.3.json"
...
import { UnsignedAchievementCredentialValidator as UnsignedAchievementCredentialValidator5 } from "@learncard/types";
var obv3PlugfestJff2 = {
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedAchievementCredentialValidator5,
...
import { UnsignedClrCredentialValidator as UnsignedClrCredentialValidator2 } from "@learncard/types";
var clrMultiAchievement = {
  ...
  signed: false,
  validity: "valid",
  validator: UnsignedClrCredentialValidator2,
  tags: ["comprehensive"],
  credential: {
    "@context": [
      "https://www.w3.org/ns/credentials/v2",
