            ...
            verifiableCredential: [
                {
                    ...
                    credentialSubject: {
                        ...
                        achievement: {
                            ...
                            description:
                                'Fundamental concepts of programming, algorithms, and computational thinking using Python.',
                            humanCode: 'CS 101',
                ...
                },
                {
                    ...
                    credentialSubject: {
                        ...
                        achievement: {
                            ...
                            description:
                                'Study of fundamental data structures (arrays, linked lists, trees, graphs, hash tables) and algorithm design, analysis, and complexity.',
                            humanCode: 'CS 201',
                            fieldOfStudy: 'Computer Science',
                            creator: {
                                id: 'https://pcu-example.edu/departments/cs',
                ...
                },
                {
                    ...
                    credentialSubject: {
                        ...
                        achievement: {
                            ...
                            description:
                                'Process management, memory management, file systems, I/O, and distributed systems. Includes substantial C programming projects.',
                            humanCode: 'CS 310',
                            fieldOfStudy: 'Computer Science',
                            creator: {
                                id: 'https://pcu-example.edu/departments/cs',
                ...
                },
                {
                    ...
                    credentialSubject: {
                        ...
                        achievement: {
                            ...
                            description:
                                'Supervised and unsupervised learning, deep learning, reinforcement learning. Hands-on projects with PyTorch.',
                            humanCode: 'CS 420',
                            fieldOfStudy: 'Computer Science',
                            creator: {
                                id: 'https://pcu-example.edu/departments/cs',
                ...
                },
                {
                    ...
                    credentialSubject: {
                        ...
                        achievement: {
                            ...
                            name: 'Linear Algebra',
                            description:
                                'Vector spaces, linear transformations, eigenvalues, matrix decompositions, and applications.',
                            humanCode: 'MATH 210',
                ...
                },
                {
                    ...
                    credentialSubject: {
                        ...
                        achievement: {
                            ...
                            description:
                                'A year-long team project applying software engineering practices to build a real-world application. Includes requirements gathering, design, implementation, testing, and deployment.',
                            humanCode: 'CS 490',
                            fieldOfStudy: 'Computer Science',
                            creator: {
                                id: 'https://pcu-example.edu/departments/cs',
            ...
            achievement: [
                {
                    ...
                    description:
                        'A four-year undergraduate program providing comprehensive training in computer science theory, systems, and applications.',
                    humanCode: 'BS-CS',
                    fieldOfStudy: 'Computer Science',
                    creator: {
                        id: 'https://pcu-example.edu/departments/cs',
