...
const buildOptions = {
    ...
    target: 'es2020',
    sourcemap: true,
    external: ['crypto', 'isomorphic-fetch', 'isomorphic-webcrypto', 'cipher-base', '@learncard/core', '@learncard/types'],
};
...
const configurations = [
    {
        ...
        format: 'cjs',
        outfile: 'dist/ceramic-plugin.cjs.development.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        minify: true,
        format: 'cjs',
        outfile: 'dist/ceramic-plugin.cjs.production.min.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        entryPoints: ['src/index.ts'],
        format: 'esm',
        outfile: 'dist/ceramic-plugin.esm.js',
        ...buildOptions,
    },
];
