...
const configurations = [
    {
        ...
        format: 'cjs',
        outfile: 'dist/dynamic-loader-plugin.cjs.development.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        minify: true,
        format: 'cjs',
        outfile: 'dist/dynamic-loader-plugin.cjs.production.min.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        entryPoints: ['src/index.ts'],
        format: 'esm',
        outfile: 'dist/dynamic-loader-plugin.esm.js',
        ...buildOptions,
    },
];
