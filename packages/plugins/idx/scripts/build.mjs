...
const buildOptions = {
    ...
    target: 'es2020',
    sourcemap: true,
    external: ['isomorphic-fetch', 'isomorphic-webcrypto', '@learncard/ceramic-plugin', '@learncard/core', '@learncard/types'],
};
...
const configurations = [
    {
        ...
        format: 'cjs',
        outfile: 'dist/idx-plugin.cjs.development.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        minify: true,
        format: 'cjs',
        outfile: 'dist/idx-plugin.cjs.production.min.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        entryPoints: ['src/index.ts'],
        format: 'esm',
        outfile: 'dist/idx-plugin.esm.js',
        ...buildOptions,
    },
];
