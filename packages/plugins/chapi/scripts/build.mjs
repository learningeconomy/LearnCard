...
const buildOptions = {
    ...
    target: 'es2020',
    sourcemap: true,
    external: ['isomorphic-fetch', 'isomorphic-webcrypto', '@learncard/core', '@learncard/didkit-plugin'],
};
...
const configurations = [
    {
        ...
        format: 'cjs',
        outfile: 'dist/chapi-plugin.cjs.development.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        minify: true,
        format: 'cjs',
        outfile: 'dist/chapi-plugin.cjs.production.min.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        entryPoints: ['src/index.ts'],
        format: 'esm',
        outfile: 'dist/chapi-plugin.esm.js',
        ...buildOptions,
    },
];
