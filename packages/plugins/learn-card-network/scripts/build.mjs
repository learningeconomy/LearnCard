...
const buildOptions = {
    ...
    target: 'es2020',
    sourcemap: true,
    external: ['isomorphic-fetch', 'isomorphic-webcrypto', '@learncard/core', '@learncard/helpers', '@learncard/network-brain-client'],
};
...
const configurations = [
    {
        ...
        format: 'cjs',
        outfile: 'dist/lcn-plugin.cjs.development.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        minify: true,
        format: 'cjs',
        outfile: 'dist/lcn-plugin.cjs.production.min.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
