...
export interface InitOutput {
  ...
  readonly closure4368_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h92ca6c7cf3784f29: (a: number, b: number) => void;
  readonly closure4748_externref_shim: (a: number, b: number, c: any, d: any) => void;
