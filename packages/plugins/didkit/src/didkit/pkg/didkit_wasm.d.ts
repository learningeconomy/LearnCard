...
export interface InitOutput {
  ...
  readonly closure4278_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen_d32f3dfee079a7d6___convert__closures_____invoke______: (a: number, b: number) => void;
  readonly closure4664_externref_shim: (a: number, b: number, c: any, d: any) => void;
