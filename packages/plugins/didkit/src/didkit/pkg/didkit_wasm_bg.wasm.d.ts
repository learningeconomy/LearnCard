...
export const closure4368_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h92ca6c7cf3784f29: (a: number, b: number) => void;
export const closure4748_externref_shim: (a: number, b: number, c: any, d: any) => void;
