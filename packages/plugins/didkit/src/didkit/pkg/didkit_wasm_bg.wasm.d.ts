...
export const wasm_bindgen__convert__closures_____invoke__h154a06e7c4f0cc46: (a: number, b: number) => void;
export const closure4301_externref_shim: (a: number, b: number, c: any) => void;
export const closure4685_externref_shim: (a: number, b: number, c: any, d: any) => void;
