...
export const closure4278_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen_d32f3dfee079a7d6___convert__closures_____invoke______: (a: number, b: number) => void;
export const closure4664_externref_shim: (a: number, b: number, c: any, d: any) => void;
