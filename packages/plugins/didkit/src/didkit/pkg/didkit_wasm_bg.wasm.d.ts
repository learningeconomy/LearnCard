...
export const closure4272_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen_2cdafc86f7ddc638___convert__closures_____invoke______: (a: number, b: number) => void;
export const closure4659_externref_shim: (a: number, b: number, c: any, d: any) => void;
