...
export declare function contextLoader(url: string): Promise<string>
export declare function createJwe(cleartext: string, recipients: Array<string>): Promise<string>
export declare function decryptJwe(jwe: string, jwksJson: Array<string>): Promise<string>
export declare function createDagJwe(cleartext: string, recipients: Array<string>): Promise<string>
export declare function decryptDagJwe(jwe: string, jwksJson: Array<string>): Promise<string>
