import type { UnsignedVC, UnsignedAchievementCredential } from '@learncard/types';

import type { VcTemplates } from './types';
...
export const VC_TEMPLATES: { [Key in keyof VcTemplates]: (args: VcTemplates[Key]) => UnsignedVC } =
    {
        ...
        boost: ({
            ...
            boostId: _boostId = 'urn:uuid:boost:example:555',
            boostImage,
