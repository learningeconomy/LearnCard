...
const configurations = [
    {
        ...
        format: 'cjs',
        outfile: 'dist/status-list-plugin.cjs.development.js',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        minify: true,
        format: 'cjs',
        outfile: 'dist/status-list-plugin.cjs.production.min.js',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        entryPoints: ['src/index.ts'],
        format: 'esm',
        outfile: 'dist/status-list-plugin.esm.js',
        ...buildOptions,
    },
];
