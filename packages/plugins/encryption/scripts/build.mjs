...
const buildOptions = {
    ...
    target: 'es2020',
    sourcemap: true,
    external: ['@learncard/core', '@learncard/types'],
};
...
const configurations = [
    {
        ...
        format: 'cjs',
        outfile: 'dist/encryption-plugin.cjs.development.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        minify: true,
        format: 'cjs',
        outfile: 'dist/encryption-plugin.cjs.production.min.cjs',
        ...buildOptions,
    },
    {
        keepNames: true,
        ...
        entryPoints: ['src/index.ts'],
        format: 'esm',
        outfile: 'dist/encryption-plugin.esm.js',
        ...buildOptions,
    },
];
