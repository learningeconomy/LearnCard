...
export const CredentialCLRBadge: React.FC<CredentialCLRBadgeProps> = ({
    ...
    return (
        ...
        >
            <div
                className={`absolute top-[10%] left-[50%] -translate-x-1/2 rounded-full border-grayscale-600 border-solid border-[3px]  overflow-hidden shadow-[0_12px_24px_rgba(24,34,78,0.18)]`}
            >
                <UserProfilePicture
                    user={subjectUser}
                    avatarColor="bg-white"
                    avatarTextClassName="text-[32px] text-grayscale-900"
            ...
            <div
                className={`absolute bottom-[20%] left-[70%] -translate-x-1/2 rounded-full border-grayscale-600 border-solid border-[3px]  overflow-hidden shadow-[0_10px_20px_rgba(24,34,78,0.16)]`}
            >
                <UserProfilePicture
                    user={issuerUser}
                    avatarColor="bg-white"
                    avatarTextClassName="text-[22px] text-[#E7A734]"
            ...
            <div
                className={`absolute bottom-[20%] left-[40%] flex h-[24px] w-[24px] items-center justify-center rounded-full border-grayscale-600 border-solid border-[3px] z-2 bg-white shadow-[0_8px_16px_rgba(24,34,78,0.16)]`}
            >
