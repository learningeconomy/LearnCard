...
import IDSleeve from '../../../svgs/IDSleeve';
import CrescentCornerLeft from '../../../svgs/CrescentCornerLeft';
import CrescentCornerRight from '../../../svgs/CrescentCornerRight';
import FamilyCMSThumbnail from './FamilyCMSThumbnail';
import EmojiRenderer from './FamilyCMSEmojiRenderer';
import QRCodeScanner from '../../../svgs/QRCodeScanner';
import { truncateWithEllipsis } from '../../../helpers/stringHelpers';
    ...
    if (showMinified) {
        return (
            <div className={`w-full relative ${containerClassName}`}>
                ...
                <div className="w-full z-[99999] absolute bottom-[60px] right-[50%] translate-x-[50%] flex items-center justify-center">
