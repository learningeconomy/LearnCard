...
export const AssistanceIcon: React.FC<{
    className?: string;
    version?: string;
    palette?: Partial<IconPalette>;
}> = ({ className = '', version, palette: inputPalette }) => {
...
export const AssistanceIconSolid: React.FC<{
    className?: string;
    palette?: Partial<IconPalette>;
}> = ({ className = '', palette: inputPalette }) => {
    const p = { ...ASSISTANCE_DEFAULTS, ...inputPalette };
    return (
        <svg
            width="78"
...
export const AssistanceIconWithShape: React.FC<{
    className?: string;
    shapeColor?: string;
    palette?: Partial<IconPalette>;
}> = ({ className = '', shapeColor, palette: inputPalette }) => {
    const p = {
        ...ASSISTANCE_DEFAULTS,
        ...(shapeColor ? { primary: shapeColor } : {}),
        ...inputPalette,
    };
    return (
        <svg
...
export const AssistanceIconWithLightShape: React.FC<{
    className?: string;
    palette?: Partial<IconPalette>;
}> = ({ className = '', palette: inputPalette }) => {
    const p = { ...ASSISTANCE_DEFAULTS, ...inputPalette };
...
export const ThickAssistanceIconWithShape: React.FC<{
    ...
    const p = {
        ...ASSISTANCE_DEFAULTS,
        ...(shapeColor ? { primaryLight: shapeColor } : {}),
        ...inputPalette,
    };
    return (
        <svg
        ...
        >
            <path
                d="M39 20.4336L20 1.43359L1 20.4336L20 39.4336L39 20.4336Z"
                fill={p.primaryLight}
            />
            <path
                fillRule="evenodd"
