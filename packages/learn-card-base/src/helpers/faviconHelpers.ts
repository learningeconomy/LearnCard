 ...
 */
export const faviconUrl = (domain: string | undefined, sizePx = 128): string | undefined => {
 ...
 */
export const preferredFaviconUrl = (host: string | undefined, sizePx = 128): string | undefined => {
    if (!host) return undefined;
