...
import { apexDomain, extractDomain, faviconUrl, preferredFaviconUrl } from '../faviconHelpers';

describe('extractDomain', () => {
    it('returns the host for a well-formed URL', () => {
        expect(extractDomain('https://issuer.demo.walt.id/path')).toBe('issuer.demo.walt.id');
    });
