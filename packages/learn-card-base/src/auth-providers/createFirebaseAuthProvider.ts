...
const firebaseUserToAuthUser = (
    cu: NonNullable<ReturnType<FirebaseAuthConfig['getAuth']>['currentUser']>
): AuthUser => ({
    id: cu.uid,
    ...
    createdAt: cu.metadata?.creationTime ? new Date(cu.metadata.creationTime) : undefined,
});
