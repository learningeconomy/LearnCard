...
export const SignInAdapterProvider: React.FC<SignInAdapterProviderProps> = ({
    children,
    ...
    return (
        <SignInAdapterContext.Provider value={adapter}>{children}</SignInAdapterContext.Provider>
    );
};
