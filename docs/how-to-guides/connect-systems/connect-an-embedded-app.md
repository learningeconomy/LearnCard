...
If you need to authenticate users or send xAPI statements, see [Identity and xAPI in Embedded Apps](./embedded-app-auth-and-xapi.md).
...
The Partner Connect SDK provides several advanced capabilities for embedded apps:
...
- [Publish Your App](../publish-your-app.md) - Submit your app to the LearnCard App Store
