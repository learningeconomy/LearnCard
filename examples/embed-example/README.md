...
-   Build command: `bunx nx build embed-example`
-   Publish directory: `dist/`

## Notes

-   The example depends on the workspace package `@learncard/embed-sdk`.
-   If you change the SDK, rebuild it with `bun --filter @learncard/embed-sdk run build` before running this example locally.
