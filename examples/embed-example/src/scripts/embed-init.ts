...
function main(): void {
    ...
    const credentialDescription =
        'What you learned: 1) Decentralized identity (DID) concepts\n2) Verifiable Credentials (VCs) fundamentals\n3) Wallets, attestations, and trust flows\n4) Using LearnCard to claim and manage credentials';
    const credentialNarrative =
        'Successfully completed the Intro to Digital Credentials course at Learning Economy Academy.';
    ...
    const hardcodedCredential = {
        ...
        'id': 'urn:uuid:857c9b52-29d8-4b0e-95d9-7812b6959452',
        'issuer': { 'id': 'did:key:z6MksfiRabqCWK3TiAAm4J3APB9ATkK3b9g6Yygu6Qx7tzZK' },
        'validFrom': '2025-09-10T19:49:11.208Z',
        'name': credentialName,
        'credentialSubject': {
            'id': 'did:example:d23dd687a7dc6787646f2eb98d0',
            'type': ['AchievementSubject'],
            'achievement': {
                'id': 'urn:uuid:39d226d4-5f63-48b8-8f23-5389a5bd37cf',
                'type': ['Achievement'],
                'achievementType': credentialType,
                'name': credentialName,
                'description': credentialDescription,
                'image': '',
                'criteria': { 'narrative': credentialNarrative },
            },
        },
        'groupID': '',
    };
