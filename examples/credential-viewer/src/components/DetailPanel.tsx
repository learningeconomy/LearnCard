        ...
        <div className="h-full flex flex-col bg-gray-900 border-l border-gray-800">
            ...
            <div className="flex-shrink-0 p-5 border-b border-gray-800">
                <div className="flex items-start justify-between gap-3 mb-3">
                    <h2 className="text-lg font-bold text-white leading-tight">{fixture.name}</h2>
                ...
                <p className="text-sm text-gray-400 leading-relaxed mb-4">{fixture.description}</p>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                        ...
                        <div className="mt-0.5 text-gray-300">{fixture.signed ? 'Yes' : 'No'}</div>
                    </div>
            ...
            {/* Issue modal */}
            {showIssuePanel && (
                <IssuePanel fixtures={[fixture]} onClose={() => setShowIssuePanel(false)} />
            )}
