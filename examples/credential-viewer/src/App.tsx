    ...
    const filtered = useMemo(() => {
        return allFixtures.filter(f => {
            ...
            if (filters.search) {
                ...
                const searchable = `${f.id} ${f.name} ${f.description} ${
                    f.tags?.join(' ') || ''
                } ${f.features.join(' ')}`.toLowerCase();
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-1.5 text-[11px] ml-1">
                                ...
                                <span className="px-1.5 py-0.5 bg-red-900/30 text-red-400 rounded">
                                    {(stats.byValidity['invalid'] || 0) +
                                        (stats.byValidity['tampered'] || 0)}{' '}
                                    invalid
                                </span>
                        ...
                        >
                            {filtered.map(fixture => (
                                <FixtureCard
                                    ...
                                    onClick={() =>
                                        setSelectedId(fixture.id === selectedId ? null : fixture.id)
                                    }
                                />
                            ))}
                        </div>
