...
import { createVerifierState, handleVerifierRequest, type VerifierState } from './verifier';
...
export const startE2EServer = async (options: { port?: number } = {}): Promise<E2EServerHandle> => {
...
const buildContext = (req: IncomingMessage, body: string, state: ServerState): HandlerContext => {
