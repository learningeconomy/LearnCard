...
var SumAggregation = /** @class */ (function (_super) {
    ...
    SumAggregation.prototype.createAggregator = function (_instrument) {
        return SumAggregation.DEFAULT_INSTANCE;
    };
    SumAggregation.DEFAULT_INSTANCE = new SumAggregator();
...
var HistogramAggregation = /** @class */ (function (_super) {
    ...
    HistogramAggregation.DEFAULT_INSTANCE = new HistogramAggregator([0, 5, 10, 25, 50, 75, 100, 250, 500, 1000]);
