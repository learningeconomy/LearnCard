...
var ViewRegistry = /** @class */ (function () {
    ...
    ViewRegistry.prototype.addView = function (view, instrumentSelector, meterSelector) {
        if (instrumentSelector === void 0) { instrumentSelector = new InstrumentSelector(); }
        if (meterSelector === void 0) { meterSelector = new MeterSelector(); }
    ...
    ViewRegistry.prototype.findViews = function (instrument, meter) {
        ...
        var views = this._registeredViews
            ...
            .map(function (it) { return it.view; });
        if (views.length === 0) {
