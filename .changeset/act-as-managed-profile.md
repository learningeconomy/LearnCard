...
- `@learncard/cli`: `serviceAccounts[].actAs` in the org spec (reconciled onto the grant), shown by `doctor` and `whoami`; new `examples/delegated-service-account.network.yaml`.
