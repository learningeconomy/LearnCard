        ...
        <IonRow className="flex w-full items-center justify-center">
            <IonCol className="mt-2 flex w-full max-w-[400px] items-center justify-center rounded-[20px] bg-white">
                <button
                    ...
                    className="text-grayscale-900 flex flex-1 items-center justify-center py-1 text-2xl font-medium font-rubik"
                >
                    {buttonText}
                </button>
            </IonCol>
...
const ModalLayout: React.FC<{
    ...
    handleOnClick: () => void;
    children: any;
}> = ({ allowScroll, buttonText, handleOnClick, children }) => {
