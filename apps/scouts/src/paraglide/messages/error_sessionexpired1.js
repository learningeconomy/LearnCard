...
*/
const error_sessionexpired1 = /** @type {((inputs?: Error_Sessionexpired1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_Sessionexpired1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_error_sessionexpired1(inputs)
});
