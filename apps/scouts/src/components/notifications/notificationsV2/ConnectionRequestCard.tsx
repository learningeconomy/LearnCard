...
const ConnectionRequestCard: React.FC<ConnectionRequestCardProps> = ({
    ...
    if (isAccepted) {
        buttonText = m['notifications.accepted']();
    } else if (!isAccepted) {
                ...
                <div className="text-left ml-3 flex flex-col items-start justify-start w-full">
                    ...
                    <div className="relative flex items-center justify-between mt-3 w-full">
                        ...
                        <button
                            ...
                            className={`rounded-[24px] flex items-center justify-center border-[1px] border-grayscale-200 border-solid h-[42px] w-[42px] bg-white font-semibold mr-2 p-[0px] tracking-wide `}
