...
export const PermissionsByRole: {
    ...
    [TroopsCMSViewModeEnum.global]: {
        ...
        canIssueChildren: JSON.stringify({ category: { $nin: [CredentialCategoryEnum.scoutId] } }),
        canCreateChildren: '*',
        canEditChildren: '*',
        canRevokeChildren: JSON.stringify({ category: { $nin: [CredentialCategoryEnum.scoutId] } }),
