...
import { UserCMSAppearance } from './scouts-cms.helpers';
...
export const ScoutPassIDCMSLayout: React.FC<{
    scoutPassID: UserCMSAppearance;
    layoutClassName?: string;
    containerClassName?: string;
    children: React.ReactNode;
}> = ({ scoutPassID, layoutClassName, containerClassName, children }) => {
    const appearance = scoutPassID;
...
export default ScoutPassIDCMSLayout;
