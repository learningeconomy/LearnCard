import { createJoseEd25519Signer, type ProofJwtSigner } from '@learncard/openid4vc-plugin';
 ...
 */
export const SIGNER_STRATEGY_PREFERENCE: readonly SignerStrategyId[] = ['did:web', 'did:key'];
...
const isStrategyApplicable = (wallet: BespokeLearnCard, strategyId: SignerStrategyId): boolean => {
    switch (strategyId) {
        case 'did:web':
 ...
 * wallet.
 */
export const getApplicableSignerStrategies = (wallet: BespokeLearnCard): SignerStrategyId[] =>
