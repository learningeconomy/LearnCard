...
describe('authCodeStorage', () => {
    ...
    describe('saveAuthCodeState', () => {
        it('persists the flow handle and offer URI', () => {
            ...
            expect(parsed.offerUri).toBe('openid-credential-offer://?credential_offer=...');
    ...
    describe('loadAuthCodeState', () => {
        ...
        it('returns null when nothing was persisted', () => {
            const loaded = loadAuthCodeState('any-state', Date.now(), 30 * 60 * 1000, storage);
        ...
        it('returns null when storage is unavailable', () => {
            const loaded = loadAuthCodeState('any-state', Date.now(), 30 * 60 * 1000, null);
