...
export const OverviewTab: React.FC<OverviewTabProps> = ({
    ...
    if (config.showApiTokens) {
        quickActions.push({
            ...
            description: m['developerPortal.dashboards.tabs.overview.tokenCount']({
    ...
    if (config.showTemplates) {
        quickActions.push({
            ...
            description: m['developerPortal.dashboards.tabs.overview.templateCount']({
                count: stats.templateCount || 0,
            }),
    ...
    if (config.showContracts) {
        quickActions.push({
            ...
            description: m['developerPortal.dashboards.tabs.overview.contractCount']({
                count: stats.activeContracts || 0,
            }),
        ...
        <div className="space-y-6">
            <div>
                <h2 className="text-lg font-semibold text-gray-800 mb-2">
                    {m['developerPortal.dashboards.tabs.overview.title']()}
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            {m['developerPortal.dashboards.tabs.overview.learnHowToIntegrate']()}
                        </p>
                    </button>
                </div>
            </div>
                ...
                {appListings && appListings.length > 1 && (
                    <div className="flex items-center justify-end mb-3">
                        <div className="relative">
                            ...
                            >
                                <option value="ALL">
                                    {m['developerPortal.dashboards.tabs.overview.allApps']()}
                                </option>
