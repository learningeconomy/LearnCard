    ...
    const renderInput = () => {
        ...
        if (type === 'select' && options) {
            ...
            return (
                ...
                >
                    <option value="">{m['developerPortal.credentialBuilder.fieldEditor.selectOption']()}</option>
            ...
            <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-amber-50 border border-amber-200 rounded-lg">
                    ...
                    <div className="flex-1">
                        <p className="text-sm text-amber-800 font-medium">{m['developerPortal.credentialBuilder.fieldEditor.autoGenerated']()}</p>
