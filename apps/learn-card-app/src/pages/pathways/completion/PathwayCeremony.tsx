...
import { arrowForwardOutline, closeOutline, sparklesOutline } from 'ionicons/icons';
...
const PathwayCeremony: React.FC<PathwayCeremonyProps> = ({ pathway, subPathways, completedAt }) => {
    const history = useHistory();

    useLockBodyScroll();

    const [reflectionDraft, setReflectionDraft] = useState(pathway.completionReflection ?? '');
    const [reflectionSaved, setReflectionSaved] = useState(!!pathway.completionReflection);
                ...
                >
                    ...
                    */}
                    ...
                    >
                        ...
                        {receipt.subPathwayCount > 0 && (
                            <>
                                ...
                                <span className="tabular-nums">
                                    ...
                                    {receipt.subPathwayCount === 1 ? 'chapter' : 'chapters'}
                                </span>
                            </>
                        )}
                        ...
                        <span className="tabular-nums">
                            <span className="text-grayscale-900 font-semibold">{receipt.days}</span>{' '}
