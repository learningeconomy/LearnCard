...
import type { CatalogEntry, CatalogSearchFilters, PathwaySearchSource } from './types';
...
export const createStaticCatalogSource = (
    ...
    return {
        async search(query: string, filters?: CatalogSearchFilters): Promise<CatalogEntry[]> {
