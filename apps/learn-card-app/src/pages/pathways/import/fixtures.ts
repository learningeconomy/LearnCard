...
export const linearFixture: CtdlGraph = {
    pathway: {
        ...
        'ceterms:hasDestinationComponent': [{ '@id': `${registry}/ce-step-destination` }],
    },
    components: {
        [`${registry}/ce-step-a`]: {
        ...
        [`${registry}/ce-step-destination`]: {
            ...
            'ceterms:description': 'Awarded to learners who complete the full sequence.',
...
export const fanInFixture: CtdlGraph = {
    pathway: {
        ...
        'ceterms:hasDestinationComponent': [{ '@id': `${registry}/ce-ai-finance-cert` }],
    },
    components: {
        [`${registry}/ce-fund-ai`]: {
            '@id': `${registry}/ce-fund-ai`,
...
export const selectionFixture: CtdlGraph = {
    pathway: {
        ...
        'ceterms:hasDestinationComponent': [{ '@id': `${registry}/ce-sel-dest` }],
    },
    components: {
        [`${registry}/ce-pick`]: {
            '@id': `${registry}/ce-pick`,
...
export const imaRealShapeFixture: CtdlGraph = {
    pathway: {
        ...
        'ceterms:hasDestinationComponent': [`${registry}/ce-e3a3a6a4-5c3b-4139-902d-7904227ee8c5`],
    },
    components: (() => {
        const uris = [
        ...
        for (const [i, ctid] of uris.entries()) {
            ...
            components[`${registry}/${ctid}`] = {
                ...
                'ceterms:credentialType': isDestination ? 'ceterms:Certificate' : 'ceterms:Badge',
            };
        }
