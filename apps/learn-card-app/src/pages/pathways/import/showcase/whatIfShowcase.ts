...
const PRIMARY_SPEC: PathwaySpec = {
    ...
    nodes: [
        ...
        },
        {
            ...
            description: 'Lightweight review cards on SQL concepts the scheduler surfaces.',
            policy: reviewPolicy(),
        ...
        },
        {
            ...
            description: 'Lightweight review cards on stats vocab the scheduler surfaces.',
            policy: reviewPolicy(),
        ...
        },
        {
            ...
            description: 'Finish the EDA module on Coursera — launched via your MCP tool.',
        ...
        },
        {
            slug: 'stats-foundations',
            title: 'Statistics Foundations',
            description: 'A nested sub-pathway that builds descriptive + inferential fluency.',
        ...
        },
        {
            ...
            description: 'Write the narrative: question, dataset, findings, caveats, next steps.',
            policy: artifactPolicy('Attach your draft (link or doc).', 'link'),
...
export const buildWhatIfShowcase = (opts: BuildShowcaseOptions): ShowcaseBundle =>
    assembleBundle({
        ...opts,
