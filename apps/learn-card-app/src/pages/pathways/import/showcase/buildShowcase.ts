    ...
    nodes: [
        ...
        },
        {
            ...
            policy: artifactPolicy(
                'Attach a link to the prototype (Figma, CodeSandbox, GitHub, etc).',
                'link'
            ),
    ...
    nodes: [
        {
            ...
            policy: artifactPolicy(
                'Attach your course completion certificate or transcript.',
                'link'
            ),
        ...
        },
        {
            ...
            credentialProjection: {
                ...
                criteria: 'Earned all four algorithm badges and completed the capstone project.',
            },
        },
    ],
    edges: [
...
const PRIMARY_SPEC: PathwaySpec = {
    ...
    nodes: [
        ...
        },
        {
            ...
            policy: artifactPolicy('Attach a 500–650 word draft of your personal statement.'),
        ...
        },
        {
            ...
            credentialProjection: {
                ...
                criteria: 'Submitted completed applications to three target AI/Finance programs.',
            },
        },
    ],
    edges: [
...
const ALL_SPECS: PathwaySpec[] = [PRIMARY_SPEC, FUTURE_READY_SPEC, AI_FINANCE_SPEC, CAPSTONE_SPEC];
