...
const WEF_MODULES_SPEC: PathwaySpec = {
    ...
    nodes: [
        ...
        },
        {
            ...
            sourceUri: 'https://www.coursera.org/learn/smart-start-collaboration',
        },
        {
            ...
            sourceUri: 'https://www.coursera.org/learn/smart-start-problem-solving',
        },
        {
            slug: 'capstone',
...
const EMPLOYER_APPS_SPEC: PathwaySpec = {
    ...
    nodes: [
        ...
        },
        {
            ...
            credentialProjection: {
                achievementType: 'milestone',
                criteria: 'Submitted five tailored applications to Smart Start partner employers.',
                alignment: [WEF_EMPLOYER_ALIGNMENT],
            },
        },
    ],
    ...
    nodes: [
        ...
        },
        {
            ...
            credentialProjection: {
                ...
                criteria: 'Completed a feedback session with a Smart Start research partner.',
            },
        },
        {
