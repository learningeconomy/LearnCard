...
const endorsementTermination = (minEndorsers: number, trustedIssuers?: string[]): Termination => ({
    kind: 'endorsement',
    minEndorsers,
...
const PORTFOLIO_OF_TRANSFERABLE_SKILLS: PathwayTemplate = {
    ...
    nodes: [
        ...
        },
        {
            ...
            description: 'Past work, side projects, volunteering — anything concrete counts.',
            policy: artifactPolicy(
        ...
        },
        {
            ...
            description: 'The version you would tell a sharp friend in 90 seconds.',
            policy: artifactPolicy(
    ...
    nodes: [
        {
            ...
            policy: artifactPolicy('Name two roles you would accept an offer from this month.'),
        ...
        },
        {
            ...
            policy: artifactPolicy('For each story, write a few sentences per STAR slot.'),
            termination: {
                kind: 'artifact-count',
                count: 5,
                artifactType: 'text',
    ...
    nodes: [
        {
            ...
            description: 'Smaller than you think. Two weeks, not two months.',
            policy: artifactPolicy(
        ...
        },
        {
            ...
            policy: artifactPolicy('Attach the draft. It does not have to be good yet.'),
            termination: {
                kind: 'artifact-count',
                count: 1,
                artifactType: 'text',
        ...
        },
        {
            ...
            description: 'Someone whose taste you trust and who will actually read it.',
            policy: artifactPolicy('Capture the feedback you got. Summaries are fine.'),
...
const FOLLOW_A_QUESTION: PathwayTemplate = {
    ...
    keywords: ['question', 'how', 'why', 'what', 'wonder', 'curious', 'inquiry'],
...
const CAPTURE_TODAYS_WORK: PathwayTemplate = {
    ...
    keywords: ['today', 'tonight', 'this week', 'right now', 'session', 'work session'],
    ...
    nodes: [
        {
            ...
            description: 'One sentence. Small enough to actually finish in one session.',
            policy: artifactPolicy(
        ...
        },
        {
            ...
            description: "What worked, what didn't, what surprised you. One sentence is enough.",
            policy: artifactPolicy(
            ...
            credentialProjection: {
                ...
                criteria: 'Named a concrete task, did it, and captured one observation.',
            },
        },
    ],
    edges: [
...
const EXPLORE_AND_NOTICE: PathwayTemplate = {
    ...
    keywords: ['curious', 'explore', 'interested', 'reading', 'lately', 'wondering', 'noticing'],
    ...
    nodes: [
        ...
        },
        {
            ...
            description: 'What caught you? Bored you? Confused you? Write it down before it fades.',
            policy: artifactPolicy(
...
export const instantiateTemplate = (
    ...
    { ownerDid, now, makeId = uuid, learnerGoalText, intentAltitude }: InstantiateOptions
): Pathway => {
    ...
    const resolvedAltitude: Altitude | undefined = intentAltitude ?? template.altitude;
