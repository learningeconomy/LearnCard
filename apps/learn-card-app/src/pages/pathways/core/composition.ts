 ...
 */
export const isPathwayCompleted = (pathways: PathwayMap, pathwayRef: string): boolean => {
 ...
 */
export const resolveCompositeChild = (pathways: PathwayMap, node: PathwayNode): Pathway | null => {
 ...
 */
export const findParentPathway = (pathways: PathwayMap, childPathwayId: string): Pathway | null => {
