...
const registerAll = (registry: RequirementMatcherRegistry): RequirementMatcherRegistry => {
    ...
    registry.set('boost-uri', matchBoostUri as LeafRequirementMatcher<LeafRequirementKind>);
    registry.set('ctdl-ctid', matchCtdlCtid as LeafRequirementMatcher<LeafRequirementKind>);
    registry.set(
    ...
    registry.set('ob-alignment', matchObAlignment as LeafRequirementMatcher<LeafRequirementKind>);
    registry.set('skill-tag', matchSkillTag as LeafRequirementMatcher<LeafRequirementKind>);
    registry.set(
        'score-threshold',
 ...
 */
export const defaultRegistry = (): RequirementMatcherRegistry => registerAll(new Map());
...
export const registerRequirementMatcher = <K extends LeafRequirementKind>(
    ...
    registry.set(kind, matcher as unknown as LeafRequirementMatcher<LeafRequirementKind>);
};
