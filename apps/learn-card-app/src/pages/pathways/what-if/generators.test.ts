...
describe('generateScenarios', () => {
    ...
    it('authors a difficulty:worse tradeoff on fast-track', () => {
        ...
        const hit = fast!.authoredTradeoffs.find(t => t.dimension === 'difficulty');
    ...
    it('authors a difficulty:better tradeoff on deep-practice', () => {
        ...
        const hit = deep!.authoredTradeoffs.find(t => t.dimension === 'difficulty');
    ...
    it('authors an external-dependency:better tradeoff on external-light', () => {
        ...
        const hit = light!.authoredTradeoffs.find(t => t.dimension === 'external-dependency');
    ...
    describe('composite-bypass', () => {
        ...
        it('authors difficulty:worse + external-dependency:better tradeoffs', () => {
            ...
            const found = generateScenarios(pathway).find(s => s.kind === 'composite-bypass');

            expect(found).toBeDefined();

            const difficulty = found!.authoredTradeoffs.find(t => t.dimension === 'difficulty');
    ...
    describe('destination-only', () => {
        ...
        it('emits when siblings exist off the shortest path', () => {
            ...
            const found = generateScenarios(pathway).find(s => s.kind === 'destination-only');
        ...
        it('does not emit when the pathway has no destination', () => {
            ...
            const found = generateScenarios(noDest).find(s => s.kind === 'destination-only');
        ...
        it('authors effort:better + difficulty:worse tradeoffs', () => {
            ...
            const effort = found!.authoredTradeoffs.find(t => t.dimension === 'effort');
            const difficulty = found!.authoredTradeoffs.find(t => t.dimension === 'difficulty');
