...
describe('simulate (core)', () => {
    ...
    it('returns an unroutable summary when focus is null or unknown', () => {
        ...
        expect(simulate(pathway, 'nope', BASELINE_SELECTOR).etaMinutes).toBeNull();
    });
    ...
    it('elides completed nodes from baseline totals', () => {
        ...
        const baseline = simulate(updated, updated.nodes[1]!.id, BASELINE_SELECTOR);
...
describe('simulateScenario', () => {
    ...
    it('preserves authored tradeoffs verbatim', () => {
        ...
        const difficulty = result.tradeoffs.find(t => t.dimension === 'difficulty');
    ...
    it('degrades gracefully on an unroutable pathway', () => {
        ...
        expect(result.tradeoffs.find(t => t.dimension === 'difficulty')).toBeDefined();
