...
import { fanInFixture, linearFixture, makeDeterministicIds } from '../import/fixtures';
...
describe('toCtdlPathway', () => {
    ...
    it('projects the root as a ceterms:Pathway with CTID preserved', () => {
        ...
        expect(graph.pathway['ceterms:ctid']).toBe('ce-fanin-0000-0000-0000-000000000000');
    });
    ...
    it('projects CredentialComponents with the right @type', () => {
        ...
        expect(components.every(c => c['@type'] === 'ceterms:CredentialComponent')).toBe(true);
    });
...
describe('toCtdlPathway — round-trip', () => {
    ...
    it('preserves the pathway CTID across round-trip', () => {
        ...
        expect(projected.pathway['ceterms:ctid']).toBe(fanInFixture.pathway['ceterms:ctid']);
    });
