...
describe('buildJourney', () => {
    ...
    it('excludes skipped nodes from both completed and remaining, but keeps them in total', () => {
        const p = pathway([node('a', 'completed'), node('b', 'skipped'), node('c', 'not-started')]);
...
describe('resolveNodeCallToAction', () => {
    ...
    it('normalizes CTDL "DigitalBadge" to "Earn this badge"', () => {
        ...
        // on purpose.
        expect(resolveNodeCallToAction(credentialNode('DigitalBadge'))).toBe('Earn this badge');
    });
...
describe('identityPhrase', () => {
    ...
    it('leaves goals already in identity form untouched', () => {
        ...
        expect(identityPhrase('someone who writes fiction')).toBe('someone who writes fiction');
...
describe('buildIdentityBanner', () => {
    ...
    it('renders a question verbatim with a "sitting with" kicker', () => {
        expect(buildIdentityBanner('why do interest rates matter?', 'question')).toEqual({
    ...
    it('renders an exploration verbatim with an "exploring" kicker', () => {
        expect(buildIdentityBanner('look around climate tech', 'exploration')).toEqual({
    ...
    it('trims surrounding whitespace on the phrase', () => {
        expect(buildIdentityBanner('  why does this matter?  ', 'question').phrase).toBe(
