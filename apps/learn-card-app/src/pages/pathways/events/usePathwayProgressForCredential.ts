...
import { computeProgressTier, type ProgressTier } from './progressCtaCopy';
...
export const usePathwayProgressForCredential = (
    ...
    const hasProgress = projected.affectedNodes.length > 0 || projected.affectedOutcomes.length > 0;
