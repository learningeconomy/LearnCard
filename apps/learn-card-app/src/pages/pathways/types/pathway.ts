 ...
 */
export const CompositeRenderStyleSchema = z.enum(['inline-expandable', 'link-out']);
 ...
 */
export const EarnUrlSourceSchema = z.enum(['sourceData', 'subjectWebpage']);
...
export const PathwaySourceSchema = z.enum(['template', 'generated', 'authored', 'ctdl-imported']);
...
// -----------------------------------------------------------------
export const AltitudeSchema = z.enum(['aspiration', 'question', 'action', 'exploration']);
