...
const nodeIsArchived = (snapshot: ServerSnapshot, pathwayId: string, nodeId: string): boolean =>
...
const decideOne = (mutation: QueuedMutation, snapshot: ServerSnapshot): ReconcileDecision => {
    switch (mutation.kind) {
        ...
        case 'commit-proposal': {
            ...
            return {
                ...
                explanation: 'That suggestion was already acted on elsewhere. Nothing to do here.',
            };
        }
