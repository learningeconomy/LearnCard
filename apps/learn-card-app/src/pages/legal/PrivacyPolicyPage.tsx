        ...
        <LegalPageLayout title={`${name} Privacy Policy`} lastUpdated="February 4, 2026">
            <Section heading="1. Overview and Design Principles">
                <p>
                    ...
                    credentialing platform designed to minimize data collection, prioritize user and
                    guardian control, and prevent monetization of learner data.
                </p>
            ...
            <Section heading="3. System Architecture and Data Custody">
                ...
                <ul className="list-disc pl-5 space-y-1">
                    <li>
                        Profile information (e.g., display name, contact method, country, date of
                        birth if provided)
                    </li>
            ...
            <Section heading="5. Analytics, Logs, and Operational Telemetry">
                ...
                <h4 className="font-semibold text-grayscale-800 mt-4">
            ...
            <Section heading="6. Data Sharing and Consent">
                <p>
                    Data sharing occurs only through explicit user, guardian, or district-authorized
                    consent flows.
                </p>
                ...
                <p>
                    Learning Economy may observe that a sharing event occurred but cannot access the
                    contents of encrypted credentials.
                </p>
            </Section>

            <Section heading="7. Children, Minors, and Educational Use">
                <p>{name} supports educational use by minors subject to appropriate safeguards.</p>
                <ul className="list-disc pl-5 space-y-1">
            ...
            <Section heading="8. Artificial Intelligence Features">
                <p>
                    ...
                    {name}-controlled systems. Learners do not interact directly with third-party AI
                    platforms.
                </p>
                ...
                <ul className="list-disc pl-5 space-y-1">
                    <li>
                        User-provided inputs and contextual learning data may be processed by
                        external AI providers
                    </li>
                    <li>
                        Learning Economy does not permit AI providers to train models on learner
                        data
                    </li>
                    <li>
                        AI providers may retain inputs and outputs in accordance with their own
                        policies
                    </li>
                </ul>
            ...
            <Section heading="Appendix B — FERPA &amp; COPPA Alignment Statement">
                ...
                <p>
                    When contracted by a school or district, Learning Economy functions as a service
                    provider acting under district direction and does not independently control
                    education records.
                </p>
