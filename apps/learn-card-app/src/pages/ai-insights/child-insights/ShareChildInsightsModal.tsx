...
import { LCNProfileManager, LCNProfile } from '@learncard/types';

import useTheme from '../../../theme/hooks/useTheme';
import { IconSetEnum } from '../../../theme/icons';

export const ShareChildInsightsModal: React.FC<{
    ...
    return (
        <div className="h-full w-full flex items-start justify-center overflow-y-auto bg-white relative">
            <div className="w-full max-w-[600px]">
                ...
                <div className="w-full ion-padding flex flex-col gap-2">
                    ...
                    <div className="flex items-center">
                        <UserProfilePicture
                            ...
                            customContainerClass="flex w-[45px] min-w-[45px] h-[45px] min-h-[45px] items-center justify-center rounded-full overflow-hidden object-cover text-white"
                        ...
                        <div className="w-full flex items-start justify-center flex-col ml-[12px]">
                            <p className="text-[22px] font-semibold text-grayscale-900 line-clamp-1 capitalize">
                                {name}
                            </p>
                        </div>
                    </div>
                ...
                {/* request button */}
                <ShareChildInsightsWithAnyoneController
                        ...
                        <div className="w-full flex flex-col gap-2">
                            ...
                            {showSearchResults &&
                                searchResults?.map((profile, index) => (
                                    <ShareChildInsightsWithUserCard
                                        key={index}
                                        childProfile={childProfile}
                                        childProfileManager={childProfileManager}
                                        profile={profile}
...
export default ShareChildInsightsModal;
