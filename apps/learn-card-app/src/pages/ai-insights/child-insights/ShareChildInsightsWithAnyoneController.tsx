...
import ChildQRCodeUserCard from './ChildQRCodeUserCard';
...
export const ShareChildInsightsWithAnyoneController: React.FC<{
    ...
    const cardTitle = (
        <h1 className="text-grayscale-900 text-2xl font-semibold text-center">
            Share {name}'s Insights <br />
            with <span className="text-indigo-500">anyone</span>.
        </h1>
    );

    const handleUserQRCodeCard = () => {
        const overrideShareLink = `${getAppBaseUrl()}/passport?shareInsights=true&learnerProfileId=${
...
export default ShareChildInsightsWithAnyoneController;
