...
const AiInsightsLearningSnapshots: React.FC<{
    ...
    const insights: AiInsightsLearningSnapshot[] = [
        {
            label: t('aiInsights.strongestArea', 'Strongest Area'),
        ...
        {
            label: t('aiInsights.weakness', 'Weakness'),
        ...
        {
            label: t('aiInsights.roomForGrowth', 'Room for Growth'),
    ...
    return (
        <div className="w-full bg-white items-center justify-center flex flex-col shadow-bottom-4-4 p-[15px] rounded-[15px]">
            <div className="w-full flex items-center justify-start">
                ...
                <h2 className="text-xl text-grayscale-800 font-notoSans">{t('aiInsights.learningSnapshots', 'Learning Snapshots')}</h2>
            </div>
