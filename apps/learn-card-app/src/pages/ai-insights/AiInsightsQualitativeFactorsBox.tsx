    ...
    return (
        <div className="flex flex-col gap-5 w-full">
            <h2 className="text-[17px] font-bold text-grayscale-900 font-poppins text-left leading-[24px]">
                {t('aiInsights.qualitativeFactors', 'Qualitative Factors')}
            </h2>

            {isBusy ? (
                <p className="text-sm text-grayscale-600">{t('aiInsights.findingQualitativeData', 'Finding qualitative data...')}</p>
            ) : occupation ? (
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-6">
                    <div className="flex flex-col items-center gap-3">
                        <AiPathwayCareerGauge
                            title={t('aiInsights.workLifeBalance', 'Work Life Balance')}
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <AiPathwayCareerGauge
                            title={t('aiInsights.jobStability', 'Job Stability')}
                ...
                <p className="text-sm text-grayscale-600 leading-relaxed">
                    {t('aiInsights.addTitleForQualitativeFactors', 'Add a professional title to see qualitative factors here.')}
                </p>
            )}

            <p className="text-xs text-grayscale-500 leading-relaxed text-left">
                {t('aiInsights.basedOnAnswersAndData', 'Based on your answers and occupation data.')}
            </p>
        </div>
    );
};
