...
export const getAiInsightsTabs = () => {
    return [
        {
            label: i18next.t('aiInsights.tabs.myInsights', 'My insights'),
            value: AiInsightsTabsEnum.MyInsights,
        },
        {
            label: i18next.t('aiInsights.tabs.learnerInsights', 'Learner insights'),
            value: AiInsightsTabsEnum.LearnerInsights,
        },
        {
            label: i18next.t('aiInsights.tabs.sharedInsights', 'Shared insights'),
            value: AiInsightsTabsEnum.SharedInsights,
        },
        {
            label: i18next.t('aiInsights.tabs.childInsights', 'Child insights'),
