...
export const RequestInsightsFromAnyoneController: React.FC<{ contractUri: string }> = ({
    contractUri,
}) => {
    ...
    const cardTitle = (
        <h1 className="text-grayscale-900 text-2xl font-semibold text-center">
            Request Insights <br />
            from <span className="text-indigo-500">anyone.</span>
        </h1>
    );
...
export default RequestInsightsFromAnyoneController;
