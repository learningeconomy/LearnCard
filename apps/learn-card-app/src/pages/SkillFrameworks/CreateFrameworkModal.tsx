...
const CreateFrameworkModal: React.FC<CreateFrameworkModalProps> = ({ isEdit, frameworkInfo }) => {
    ...
    const handleSelectAdmin = () => {
        newModal(
            <BoostSearch
                ...
                cssClass="boost-search-modal mt-[var(--ion-safe-area-top,0px)]"
    ...
    return (
        <div className="h-full relative bg-grayscale-50 overflow-hidden">
            <div className="px-[20px] py-[20px] bg-white mt-[var(--ion-safe-area-top,0px)] flex flex-col gap-[10px] z-20 relative border-b-[1px] border-grayscale-200 border-solid rounded-b-[30px]">
