...
const ManageSkills: React.FC<ManageSkillsProps> = ({
    ...
    const annotateWithIcons = useCallback(
        async (framework: SkillFramework): Promise<SkillFramework> => {
            try {
                ...
                log.error('Error generating icons for skills:', e);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            log.error('Failed to add skills to framework:', error);
    ...
    return (
        <div className="h-full relative bg-grayscale-100 flex flex-col">
            ...
            <div className="ion-padding p-[20px] bg-white mt-[var(--ion-safe-area-top,0px)] rounded-b-[30px] shadow-bottom-1-5 flex flex-col gap-[10px] z-20 relative">
