...
const BulkImportMissingImagesError: React.FC<BulkImportMissingImagesErrorProps> = ({
    ...
    return (
        <div className="bg-orange-100 rounded-[16px] p-4 mb-6 max-w-[800px] mx-auto">
            <h3 className="text-orange-700 font-medium flex items-center">
                <WarningIcon className="h-[24px] w-[24px] mr-2" /> Missing Images
            </h3>
            <p className="text-orange-700 mb-2 mt-2">
                The following records are missing image URLs:
            </p>
            <ul className="text-orange-700 list-disc pl-6 mb-4">
