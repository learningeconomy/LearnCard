...
export const GitHubStarCard: React.FC<GitHubStarCardProps> = ({
    ...
    <div
        className={`font-poppins relative flex items-center gap-3 p-3 pr-9 rounded-2xl border border-grayscale-200 bg-grayscale-10 animate-fade-in-up ${className}`}
    ...
    >
        ...
        <p className="flex-1 text-xs text-grayscale-600 leading-relaxed text-left">
        ...
        <button
            ...
            className="absolute top-2 right-2 p-1.5 rounded-full text-grayscale-400 hover:text-grayscale-700 hover:bg-grayscale-100 transition-colors"
