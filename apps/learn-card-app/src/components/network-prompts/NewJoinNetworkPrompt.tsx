...
const NewJoinNetworkPrompt: React.FC<NewJoinNetworkPromptProps> = ({ handleCloseModal }) => {
    ...
    // if an LCN profile already exists return nothing
    if (lcNetworkProfile?.profileId && !isLoading) return <></>;

    return (
        <>
            {createLoading && (
                <div className="absolute top-0 w-full h-full z-[10000] flex flex-col gap-[5px] items-center justify-center bg-white bg-opacity-70 backdrop-blur-[3px]">
                ...
                <IonRow class="w-full">
                    <IonRow className="flex w-full flex-col items-center justify-center mb-2">
                        <div className="flex w-full items-center justify-center">
                            ...
                            >
                                <span className="font-poppings font-normal text-center">
                                    Welcome to
                                </span>
                                <br />
                                <HeaderBranding
                ...
                <div className="flex flex-col items-center justify-center w-full px-6 mt-4">
                    ...
                    <IonRow className="w-full flex flex-col items-center justify-center">
                        <div className="w-full flex items-center justify-between">
                            <p className="text-grayscale-900 font-normal text-base w-10/12 text-left pr-2 font-poppins">
                                Join the LearnCard Network
                            </p>
                            {/* <IonToggle
                                mode="ios"
                                color="emerald-700"
                                onIonChange={() => setNetworkToggle(!networkToggle)}
                                checked={networkToggle}
                            /> */}
                        </div>
                        {networkToggle && (
                            <p className="text-grayscale-600 font-normal text-[11px] w-full text-left font-poppins mt-2">
                                The LearnCard Network allows you to exchange credentials and badges
                                with other members.{' '}
                    ...
                    {!networkToggle && (
                        <IonRow className="w-full flex flex-col items-center justify-center mt-4">
                            <p className="text-grayscale-900 font-normal text-base w-full text-left font-poppins">
                                You can still use LearnCard without joining the network.
                            </p>
                            <p className="text-grayscale-600 font-normal text-[14px] w-full text-left font-poppins mt-2">
                    ...
                    <IonRow className="w-full flex items-center justify-center mt-8">
                        <button
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? m['common.loading']() : "Let's Go!"}
                        </button>
                    </IonRow>
                </div>
