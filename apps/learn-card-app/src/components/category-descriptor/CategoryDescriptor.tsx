...
export const CategoryDescriptor: React.FC<{ category: BoostCategoryOptionsEnum | string, className: string }> = ({
    category,
    className,
}) => {
    ...
    return (
        <div className="relative text-grayscale-900 z-9999">
            <p
            className={className || "text-black max-w-[400px] text-center mx-auto mt-10 pb-5"}
            >
