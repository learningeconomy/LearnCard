...
`,
    ...
    [CredentialCategoryEnum.aiInsight]: {
        id: 9,
        text: `Insights are intelligent summaries generated from an individual's verified credentials, skills,
    ...
    aiPathway: {
        id: 10,
        text: `Pathways are personalized learning journeys generated by analyzing your verified skills,
        credentials, and career interests. They map out recommended courses, experiences, and milestones
        tailored to your goals, helping you discover new opportunities and build toward the career or
        learning outcomes that matter most to you.`,
        type: 'aiPathway' as CredentialCategoryEnum,
    },
};
