...
const RouteTransitionLoader: React.FC = () => {
    ...
    const bgColor = theme.colors.defaults.passportBgColor ?? 'var(--ion-background-color, #ffffff)';
    ...
    return (
        ...
        >
            <IonSpinner name="crescent" style={{ color: spinnerColor, width: 36, height: 36 }} />
        </div>
    );
};
