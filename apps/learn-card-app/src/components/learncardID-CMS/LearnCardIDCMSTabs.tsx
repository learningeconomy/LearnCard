...
export enum LearnCardIDCMSTabsEnum {
    dark = 'dark',
    light = 'light',
    custom = 'custom',
}

const LearnCardIDCMSTabs: React.FC<{
    activeTab: LearnCardIDCMSTabsEnum;
    handleTabSwitch: (tab: LearnCardIDCMSTabsEnum) => void;
    ...
    return (
        <IonRow className="flex w-full items-center justify-center bg-white mt-4">
            ...
            >
                <IonSegmentButton
                    mode="ios"
                    value={LearnCardIDCMSTabsEnum.dark}
                    className="py-[12px]"
                    onClick={e => {
                        e.stopPropagation();
                    }}
                ...
                <IonSegmentButton
                    mode="ios"
                    value={LearnCardIDCMSTabsEnum.light}
                    className="py-[12px]"
                    onClick={e => {
                        e.stopPropagation();
                    }}
                ...
                <IonSegmentButton
                    mode="ios"
                    value={LearnCardIDCMSTabsEnum.custom}
                    className="py-[12px]"
                    onClick={e => {
                        e.stopPropagation();
                    }}
...
export default LearnCardIDCMSTabs;
