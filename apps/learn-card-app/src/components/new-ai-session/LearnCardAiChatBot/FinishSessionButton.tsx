...
const FinishSessionButton: React.FC = () => {
    ...
    if (mode === AiSessionMode.insights) {
        return (
            <div className="flex justify-between items-center gap-[15px] p-[15px] absolute top-[0px] left-[0px] w-full bg-white shadow-box-bottom z-[100000] safe-area-inset-top">
