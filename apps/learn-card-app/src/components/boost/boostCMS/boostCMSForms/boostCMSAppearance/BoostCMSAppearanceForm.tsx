...
const BoostCMSColorPickerWrapper: React.FC<{
    closeModal: () => void;
    color: string;
...
const BoostCMSAppearanceForm: React.FC<BoostCMSAppearanceFormProps> = ({
    state,
    setState,
    disabled = false,
                    ...
                    <div className="w-full flex items-center justify-center p-0 m-0 mt-4">
                        <div className="relative w-full flex items-center justify-between">
                            <input
                                ...
                                placeholder={m['boost.cms.appearance.colorHexCode']()}
                                type="text"
                                disabled={disabled}
                            />
