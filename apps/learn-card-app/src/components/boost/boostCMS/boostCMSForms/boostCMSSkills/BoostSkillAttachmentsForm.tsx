...
type BoostCMSSkillsAttachmentFormProps = {
    state: BoostCMSState;
    setState: React.Dispatch<React.SetStateAction<BoostCMSState>>;
};

export const BoostCMSSkillsAttachmentForm: React.FC<BoostCMSSkillsAttachmentFormProps> = ({
    state,
    setState,
}) => {
            ...
            >
                <button className="flex items-center justify-between w-full ion-padding"
                    onClick={() => {
                        ...
                        if (isMobile) {
                            ...
                            //             handleAddSkill(
                            //                 skill,
                            //                 BoostCMSSkillsAttachmentFormModeEnum.edit
                            //             )
                            //         }
                            //         handleRemoveSkill={(
                            //             skill: BoostCMSSkill | string,
                ...
                >
                    <h1 className="font-poppins text-grayscale-900 text-xl p-0 m-0 flex items-center justify-center">
                        <PuzzlePiece className="h-[30px] w-[30px] mr-1 text-violet-500" /> Skill
                        Attachments
                    </h1>
