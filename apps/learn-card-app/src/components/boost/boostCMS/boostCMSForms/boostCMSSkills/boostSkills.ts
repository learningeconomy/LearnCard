...
// The above urls temporarily disabled in favor of filestack urls
// Reason is until we figure out the issue where the assets hash changes
// and for some reason it breaks after a live update
...
export const boostCMSSKillCategories: {
...
}[] = [
    {
        id: 1,
        title: 'Durable',
        description: 'Timeless life skills',
        IconComponent: 'https://cdn.filestackcontent.com/RQRqkFZRQS1wYzCoCLAc',
    ...
    },
    {
        ...
        IconComponent: 'https://cdn.filestackcontent.com/crdfgbkoSQmaODizxYHI',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
    ...
    },
    {
        id: 3,
        title: 'Athletic',
        description: 'Strength, agility, focus',
        IconComponent: 'https://cdn.filestackcontent.com/s25o4zuGQlmGGnCIYcPh',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
    ...
    },
    {
        ...
        IconComponent: 'https://cdn.filestackcontent.com/sV5USMHSKidKRQQaJ2LO',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
    ...
    },
    {
        id: 5,
        title: 'Business',
        description: 'Money and strategy',
        IconComponent: 'https://cdn.filestackcontent.com/UhzgDPB2QoqUnCAXSjvk',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
    ...
    },
    {
        id: 6,
        title: 'Trade',
        description: 'Skilled hands-on work',
        IconComponent: 'https://cdn.filestackcontent.com/x9THCPXnQamq8APwBepe',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
    ...
    },
    {
        ...
        IconComponent: 'https://cdn.filestackcontent.com/8kMUCDUT2EGwhY0zYt2A',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
    ...
    },
    {
        id: 8,
        title: 'Digital',
        description: 'Computers and the internet',
        IconComponent: 'https://cdn.filestackcontent.com/S3vWIgzuQBiOxcWuOG0j',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
    ...
    },
    {
        ...
        IconComponent: 'https://cdn.filestackcontent.com/xNHR2AohRxCmfhjRfpdB',
        iconClassName: 'text-white',
        iconCircleClass: 'bg-violet-200',
