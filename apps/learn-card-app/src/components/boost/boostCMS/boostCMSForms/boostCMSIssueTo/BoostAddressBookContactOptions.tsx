...
const BoostAddressBookContactOptions: React.FC<BoostAddressBookContactOptionsProps> = ({
    state,
    setIssueMode,
    setState,
    handleCloseModal,
    ...
    const [presentCenterModal, dismissCenterModal] = useIonModal(AddressBookQRCode, {
        ...
        showCloseButton: true,
        title: (
            <p className="font-poppins flex items-center justify-center text-xl w-full h-full text-grayscale-900 text-center">
                Add Contact
            </p>
        ),
        subTitle: (
    ...
    // TODO can't test this one bc Native
    ...
    const handleAddYoself = () => {
        if (currentLCNUser) {
            ...
            try {
                ...
                setIssueMode?.(BoostUserTypeEnum.self);
                ...
                <IonGrid className="ion-padding">
                    ...
                    {/* <IonCol className="w-full flex items-center justify-center">
                        <button
                            ...
                            className="flex items-center justify-center bg-grayscale-900 rounded-full px-[18px] py-[12px] text-white font-poppins text-xl w-full shadow-lg modal-btn-desktop normal"
                        >
