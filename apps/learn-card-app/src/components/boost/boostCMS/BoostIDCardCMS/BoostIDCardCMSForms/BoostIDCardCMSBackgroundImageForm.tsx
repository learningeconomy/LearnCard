        ...
        <div className="flex flex-col items-center justify-center bg-white rounded-[20px] w-full font-medium text-lg mt-4">
            ...
            <div className="flex items-center justify-between w-full bg-grayscale-100 rounded-tl-[10px] rounded-bl-[10px] rounded-tr-[50px] rounded-br-[50px] mt-2">
                <div className="flex items-center justify-start w-[70%] px-[6px] py-[6px] overflow-hidden">
                    <div
                        className={`relative flex items-center justify-center object-contain overflow-hidden w-[72px] h-[72px] bg-white rounded-[10px]`}
                    >
                ...
                <div className="flex items-center justify-center rounded-full bg-white mr-4 h-[50px] w-[50px] shadow-3xl">
                    <button disabled={disabled} onClick={handleImageSelect} className="bg-white">
            ...
            <div className="w-full flex items-center justify-between px-[8px] py-[8px]">
                ...
                <IonToggle
                    ...
                    color="emerald-700"
                    onIonChange={() => {
                        const dimIdBackgroundImage = !state?.appearance?.dimIdBackgroundImage;
                        handleStateChange('dimIdBackgroundImage', dimIdBackgroundImage);
                    }}
                    checked={state?.appearance?.dimIdBackgroundImage}
                    disabled={disabled}
                />
            </div>
        </div>
...
export default BoostIDCardCMSBackgroundImageForm;
