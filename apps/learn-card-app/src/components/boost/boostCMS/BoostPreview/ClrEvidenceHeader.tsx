...
const ClrEvidenceHeader: React.FC<ClrEvidenceHeaderProps> = ({ evidence }) => {
    ...
    return (
        <div className="shrink-0 border-b border-grayscale-200 bg-white/95 backdrop-blur-sm px-4 py-3 mt-[var(--lc-overlay-inset-top,var(--ion-safe-area-top,0px))] absolute top-0 left-0 right-0 z-9999 flex items-center justify-between">
