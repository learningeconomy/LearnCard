...
export const AddUser: React.FC<{
    ...
    fill?: string;
    version?: '1' | '2' | '3' | '4';
}> = ({ className, fill = 'oklch(87.9% 0.169 91.605)', version = '1' }) => {
    if (version === '4') {
        // greeen hue
        // switcher button
        return (
            ...
            >
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M16.4623 25.7773C10.0557 25.7773 4.58398 26.7457 4.58398 30.6257C4.58398 34.504 10.0207 35.509 16.4623 35.509C22.869 35.509 28.3406 34.539 28.3406 30.6607C28.3406 26.7823 22.904 25.7773 16.4623 25.7773Z"
                    stroke="#047857"
                    strokeWidth="2"
                    strokeLinecap="round"
                ...
                <path
                    ...
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M16.4625 20.2423C20.6891 20.2423 24.0758 16.854 24.0758 12.629C24.0758 8.40229 20.6891 5.01562 16.4625 5.01562C12.2375 5.01562 8.84912 8.40229 8.84912 12.629C8.84912 16.854 12.2375 20.2423 16.4625 20.2423Z"
                    fill="#6EE7B7"
                    stroke="#047857"
                    strokeWidth="2"
                    strokeLinecap="round"
        ...
        return (
            ...
            >
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M14.4043 22.6094C8.79845 22.6094 4.01074 23.4567 4.01074 26.8517C4.01074 30.2452 8.76783 31.1246 14.4043 31.1246C20.0101 31.1246 24.7978 30.2758 24.7978 26.8823C24.7978 23.4888 20.0407 22.6094 14.4043 22.6094Z"
                    stroke="#353E64"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <path
                    ...
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M14.4043 17.7667C18.1027 17.7667 21.066 14.8019 21.066 11.105C21.066 7.40669 18.1027 4.44336 14.4043 4.44336C10.7075 4.44336 7.74268 7.40669 7.74268 11.105C7.74268 14.8019 10.7075 17.7667 14.4043 17.7667Z"
                    fill="#C5C8D3"
                    stroke="#353E64"
                    strokeWidth="1.5"
                    strokeLinecap="round"
