...
export const networkSettingOptions: NetworkSettingOptions[] = [
    {
        ...
        description:
            'LearnCard acts as a gateway that sends encrypted connection requests on your behalf.',
    ...
    },
    {
        ...
        description:
            'LearnCard acts as a gateway that receives encrypted connection requests on your behalf.',
