        ...
        <>
            ...
            {!Capacitor.isNativePlatform() && (
                <div className="w-full flex items-center justify-between px-6">
                    ...
                    >
                        <HandshakeIcon className="mr-2" /> {m['profile.connectingHandler']()}
                    </button>
                    <button
                ...
                <IonRow className="flex flex-col items-center justify-center w-full">
                        ...
                        <>
                            <div className="flex flex-col items-center justify-center w-full mb-2 mt-2">
                                <DatePickerInput
                                    ...
                                    error={errors?.dob?.[0]}
                                    isMobile={!isDesktop}
                                    label={`${m['profile.dateOfBirth']()} ${
                                        hasParentSwitchedProfile ? m['profile.disabled']() : ''
                                    }`}
                    ...
                    {email && !hasParentSwitchedProfile && (
                        <IonInput
                            ...
                            value={email}
                            placeholder={m['profile.emailAddress']()}
                            type="email"
                            disabled={true}
                        />
                    )}
                    {phone && (
                        <IonInput
                            ...
                            value={phone}
                            placeholder={m['profile.phoneNumber']()}
                            type="tel"
                            disabled={true}
                        />
                    )}
