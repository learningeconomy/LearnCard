...
const es_wallet_categories_aipathways1 = /** @type {(inputs: Wallet_Categories_Aipathways1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Trayectos IA`)
};
...
*/
const wallet_categories_aipathways1 = /** @type {((inputs?: Wallet_Categories_Aipathways1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Wallet_Categories_Aipathways1Inputs, { locale?: "en" | "es" | "de" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
