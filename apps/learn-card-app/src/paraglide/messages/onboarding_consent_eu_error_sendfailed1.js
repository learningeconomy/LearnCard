...
const de_onboarding_consent_eu_error_sendfailed1 = /** @type {(inputs: Onboarding_Consent_Eu_Error_Sendfailed1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Zustimmungsanfrage konnte nicht gesendet werden. Bitte versuche es erneut.`)
};
...
const ko_onboarding_consent_eu_error_sendfailed1 = /** @type {(inputs: Onboarding_Consent_Eu_Error_Sendfailed1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`동의 요청을 보내지 못했습니다. 다시 시도해 주세요.`)
};
...
*/
const onboarding_consent_eu_error_sendfailed1 = /** @type {((inputs?: Onboarding_Consent_Eu_Error_Sendfailed1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Eu_Error_Sendfailed1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_consent_eu_error_sendfailed1(inputs)
	if (locale === "ar") return ar_onboarding_consent_eu_error_sendfailed1(inputs)
	if (locale === "fr") return fr_onboarding_consent_eu_error_sendfailed1(inputs)
	return ko_onboarding_consent_eu_error_sendfailed1(inputs)
});
