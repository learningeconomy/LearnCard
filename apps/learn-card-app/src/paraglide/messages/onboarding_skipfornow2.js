...
*/
const onboarding_skipfornow2 = /** @type {((inputs?: Onboarding_Skipfornow2Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Skipfornow2Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_onboarding_skipfornow2(inputs)
});
