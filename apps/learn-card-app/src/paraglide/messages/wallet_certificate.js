...
const de_wallet_certificate = /** @type {(inputs: Wallet_CertificateInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Zertifikat`)
};
...
const ko_wallet_certificate = /** @type {(inputs: Wallet_CertificateInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`인증서`)
};
...
*/
const wallet_certificate = /** @type {((inputs?: Wallet_CertificateInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Wallet_CertificateInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_wallet_certificate(inputs)
	if (locale === "es") return es_wallet_certificate(inputs)
	if (locale === "de") return de_wallet_certificate(inputs)
	if (locale === "ar") return ar_wallet_certificate(inputs)
	if (locale === "fr") return fr_wallet_certificate(inputs)
	return ko_wallet_certificate(inputs)
});
