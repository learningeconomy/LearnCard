...
*/
const onboarding_profile_age = /** @type {((inputs: Onboarding_Profile_AgeInputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Profile_AgeInputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs, options = {}) => {
	...
	return ar_onboarding_profile_age(inputs)
});
