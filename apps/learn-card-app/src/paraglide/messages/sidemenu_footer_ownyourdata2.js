...
const ko_sidemenu_footer_ownyourdata2 = /** @type {(inputs: Sidemenu_Footer_Ownyourdata2Inputs) => LocalizedString} */ () => {
...
*/
const sidemenu_footer_ownyourdata2 = /** @type {((inputs?: Sidemenu_Footer_Ownyourdata2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sidemenu_Footer_Ownyourdata2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_sidemenu_footer_ownyourdata2(inputs)
	if (locale === "fr") return fr_sidemenu_footer_ownyourdata2(inputs)
	return ko_sidemenu_footer_ownyourdata2(inputs)
});
