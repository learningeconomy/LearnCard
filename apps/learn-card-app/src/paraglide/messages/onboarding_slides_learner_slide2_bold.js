...
*/
const onboarding_slides_learner_slide2_bold = /** @type {((inputs?: Onboarding_Slides_Learner_Slide2_BoldInputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Slides_Learner_Slide2_BoldInputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_onboarding_slides_learner_slide2_bold(inputs)
});
