...
const de_wallet_categories_aisessions1 = /** @type {(inputs: Wallet_Categories_Aisessions1Inputs) => LocalizedString} */ () => {
...
const ko_wallet_categories_aisessions1 = /** @type {(inputs: Wallet_Categories_Aisessions1Inputs) => LocalizedString} */ () => {
...
*/
const wallet_categories_aisessions1 = /** @type {((inputs?: Wallet_Categories_Aisessions1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Wallet_Categories_Aisessions1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_wallet_categories_aisessions1(inputs)
	if (locale === "ar") return ar_wallet_categories_aisessions1(inputs)
	if (locale === "fr") return fr_wallet_categories_aisessions1(inputs)
	return ko_wallet_categories_aisessions1(inputs)
});
