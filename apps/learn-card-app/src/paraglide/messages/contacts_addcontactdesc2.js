...
*/
const contacts_addcontactdesc2 = /** @type {((inputs?: Contacts_Addcontactdesc2Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Contacts_Addcontactdesc2Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_contacts_addcontactdesc2(inputs)
});
