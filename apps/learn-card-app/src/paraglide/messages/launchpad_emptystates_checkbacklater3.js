...
*/
const launchpad_emptystates_checkbacklater3 = /** @type {((inputs?: Launchpad_Emptystates_Checkbacklater3Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Emptystates_Checkbacklater3Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
