...
const de_onboarding_slides_teacher_slide4_bold = /** @type {(inputs: Onboarding_Slides_Teacher_Slide4_BoldInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Bewerte`)
};
...
const ko_onboarding_slides_teacher_slide4_bold = /** @type {(inputs: Onboarding_Slides_Teacher_Slide4_BoldInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`평가`)
};
...
*/
const onboarding_slides_teacher_slide4_bold = /** @type {((inputs?: Onboarding_Slides_Teacher_Slide4_BoldInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Slides_Teacher_Slide4_BoldInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_slides_teacher_slide4_bold(inputs)
	if (locale === "ar") return ar_onboarding_slides_teacher_slide4_bold(inputs)
	if (locale === "fr") return fr_onboarding_slides_teacher_slide4_bold(inputs)
	return ko_onboarding_slides_teacher_slide4_bold(inputs)
});
