...
const de_toasts_boost_boostsavedsuccess2 = /** @type {(inputs: Toasts_Boost_Boostsavedsuccess2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Boost erfolgreich gespeichert`)
};
...
const ko_toasts_boost_boostsavedsuccess2 = /** @type {(inputs: Toasts_Boost_Boostsavedsuccess2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`부스트가 성공적으로 저장됨`)
};
...
*/
const toasts_boost_boostsavedsuccess2 = /** @type {((inputs?: Toasts_Boost_Boostsavedsuccess2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Boost_Boostsavedsuccess2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_toasts_boost_boostsavedsuccess2(inputs)
	if (locale === "ar") return ar_toasts_boost_boostsavedsuccess2(inputs)
	if (locale === "fr") return fr_toasts_boost_boostsavedsuccess2(inputs)
	return ko_toasts_boost_boostsavedsuccess2(inputs)
});
