...
const de_launchpad_emptystates_noappsavailable3 = /** @type {(inputs: Launchpad_Emptystates_Noappsavailable3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Aktuell keine Apps verfügbar`)
};
...
const ko_launchpad_emptystates_noappsavailable3 = /** @type {(inputs: Launchpad_Emptystates_Noappsavailable3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`현재 사용 가능한 앱이 없습니다`)
};
...
*/
const launchpad_emptystates_noappsavailable3 = /** @type {((inputs?: Launchpad_Emptystates_Noappsavailable3Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Emptystates_Noappsavailable3Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_launchpad_emptystates_noappsavailable3(inputs)
	if (locale === "fr") return fr_launchpad_emptystates_noappsavailable3(inputs)
	return ko_launchpad_emptystates_noappsavailable3(inputs)
});
