...
const de_login_linkedbanner_withhint2 = /** @type {((inputs: Login_Linkedbanner_Withhint2Inputs) => LocalizedString) & { parts: (inputs: Login_Linkedbanner_Withhint2Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Login_Linkedbanner_Withhint2Inputs) => LocalizedString} */ ((i) => {
			return /** @type {LocalizedString} */ (`Melde dich mit ${i?.hint} an, um fortzufahren`)
		}),
		{
			parts: /** @type {(inputs: Login_Linkedbanner_Withhint2Inputs) => import('../runtime.js').MessagePart[]} */ ((i) => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "Melde dich mit " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: String(i?.hint) }, { type: "markup-end", name: "0", options: {}, attributes: {} }, { type: "text", value: " an, um fortzufahren" }])
			})
		}
	)
);
...
const ko_login_linkedbanner_withhint2 = /** @type {((inputs: Login_Linkedbanner_Withhint2Inputs) => LocalizedString) & { parts: (inputs: Login_Linkedbanner_Withhint2Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Login_Linkedbanner_Withhint2Inputs) => LocalizedString} */ ((i) => {
			return /** @type {LocalizedString} */ (`${i?.hint}(으)로 로그인하여 완료하세요`)
		}),
		{
			parts: /** @type {(inputs: Login_Linkedbanner_Withhint2Inputs) => import('../runtime.js').MessagePart[]} */ ((i) => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: String(i?.hint) }, { type: "markup-end", name: "0", options: {}, attributes: {} }, { type: "text", value: "(으)로 로그인하여 완료하세요" }])
			})
		}
	)
);
...
*/
const login_linkedbanner_withhint2 = /** @type {((inputs: Login_Linkedbanner_Withhint2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & { parts: (inputs: Login_Linkedbanner_Withhint2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => import('../runtime.js').MessagePart[] } & import('../runtime.js').MessageMetadata<Login_Linkedbanner_Withhint2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, { "0": { options: {}; attributes: {}; children: true } }>} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Login_Linkedbanner_Withhint2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString} */ ((inputs, options = {}) => {
			...
			if (locale === "de") return de_login_linkedbanner_withhint2(inputs)
			if (locale === "ar") return ar_login_linkedbanner_withhint2(inputs)
			if (locale === "fr") return fr_login_linkedbanner_withhint2(inputs)
			return ko_login_linkedbanner_withhint2(inputs)
		}),
		{
			parts: /** @type {(inputs: Login_Linkedbanner_Withhint2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => import('../runtime.js').MessagePart[]} */ ((inputs, options = {}) => {
				const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
				...
				if (locale === "de") return typeof de_login_linkedbanner_withhint2.parts === "function" ? de_login_linkedbanner_withhint2.parts(inputs) : [{ type: "text", value: de_login_linkedbanner_withhint2(inputs) }]
				if (locale === "ar") return typeof ar_login_linkedbanner_withhint2.parts === "function" ? ar_login_linkedbanner_withhint2.parts(inputs) : [{ type: "text", value: ar_login_linkedbanner_withhint2(inputs) }]
				...
				return typeof ko_login_linkedbanner_withhint2.parts === "function" ? ko_login_linkedbanner_withhint2.parts(inputs) : [{ type: "text", value: ko_login_linkedbanner_withhint2(inputs) }]
			})
		}
	)
);
