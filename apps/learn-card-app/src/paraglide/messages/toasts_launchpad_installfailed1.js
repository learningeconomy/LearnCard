...
const de_toasts_launchpad_installfailed1 = /** @type {(inputs: Toasts_Launchpad_Installfailed1Inputs) => LocalizedString} */ (i) => {
...
const ko_toasts_launchpad_installfailed1 = /** @type {(inputs: Toasts_Launchpad_Installfailed1Inputs) => LocalizedString} */ (i) => {
...
*/
const toasts_launchpad_installfailed1 = /** @type {((inputs: Toasts_Launchpad_Installfailed1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Launchpad_Installfailed1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs, options = {}) => {
	...
	if (locale === "de") return de_toasts_launchpad_installfailed1(inputs)
	if (locale === "ar") return ar_toasts_launchpad_installfailed1(inputs)
	if (locale === "fr") return fr_toasts_launchpad_installfailed1(inputs)
	return ko_toasts_launchpad_installfailed1(inputs)
});
