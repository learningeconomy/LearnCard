...
const de_settings_privacy_connectionrequests1 = /** @type {(inputs: Settings_Privacy_Connectionrequests1Inputs) => LocalizedString} */ () => {
...
const ko_settings_privacy_connectionrequests1 = /** @type {(inputs: Settings_Privacy_Connectionrequests1Inputs) => LocalizedString} */ () => {
...
*/
const settings_privacy_connectionrequests1 = /** @type {((inputs?: Settings_Privacy_Connectionrequests1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Privacy_Connectionrequests1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_settings_privacy_connectionrequests1(inputs)
	if (locale === "ar") return ar_settings_privacy_connectionrequests1(inputs)
	if (locale === "fr") return fr_settings_privacy_connectionrequests1(inputs)
	return ko_settings_privacy_connectionrequests1(inputs)
});
