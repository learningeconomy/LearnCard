...
const de_onboarding_consent_parentinvite_sendinvite2 = /** @type {(inputs: Onboarding_Consent_Parentinvite_Sendinvite2Inputs) => LocalizedString} */ () => {
...
const ko_onboarding_consent_parentinvite_sendinvite2 = /** @type {(inputs: Onboarding_Consent_Parentinvite_Sendinvite2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`초대 보내기`)
};
...
*/
const onboarding_consent_parentinvite_sendinvite2 = /** @type {((inputs?: Onboarding_Consent_Parentinvite_Sendinvite2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Parentinvite_Sendinvite2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_consent_parentinvite_sendinvite2(inputs)
	if (locale === "ar") return ar_onboarding_consent_parentinvite_sendinvite2(inputs)
	if (locale === "fr") return fr_onboarding_consent_parentinvite_sendinvite2(inputs)
	return ko_onboarding_consent_parentinvite_sendinvite2(inputs)
});
