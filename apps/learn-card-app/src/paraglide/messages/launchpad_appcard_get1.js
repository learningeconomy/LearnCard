...
*/
const launchpad_appcard_get1 = /** @type {((inputs?: Launchpad_Appcard_Get1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Appcard_Get1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_launchpad_appcard_get1(inputs)
});
