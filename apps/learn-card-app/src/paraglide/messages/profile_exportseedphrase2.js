...
*/
const profile_exportseedphrase2 = /** @type {((inputs?: Profile_Exportseedphrase2Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Profile_Exportseedphrase2Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_profile_exportseedphrase2(inputs)
});
