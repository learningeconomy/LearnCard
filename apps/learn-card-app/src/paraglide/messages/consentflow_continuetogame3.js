...
const de_consentflow_continuetogame3 = /** @type {(inputs: Consentflow_Continuetogame3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Zum Spiel fortfahren`)
};
...
const ko_consentflow_continuetogame3 = /** @type {(inputs: Consentflow_Continuetogame3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`게임으로 계속`)
};
...
*/
const consentflow_continuetogame3 = /** @type {((inputs?: Consentflow_Continuetogame3Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Consentflow_Continuetogame3Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_consentflow_continuetogame3(inputs)
	if (locale === "ar") return ar_consentflow_continuetogame3(inputs)
	if (locale === "fr") return fr_consentflow_continuetogame3(inputs)
	return ko_consentflow_continuetogame3(inputs)
});
