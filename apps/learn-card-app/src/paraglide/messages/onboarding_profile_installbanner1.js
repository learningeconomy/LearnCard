...
const de_onboarding_profile_installbanner1 = /** @type {((inputs: Onboarding_Profile_Installbanner1Inputs) => LocalizedString) & { parts: (inputs: Onboarding_Profile_Installbanner1Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Onboarding_Profile_Installbanner1Inputs) => LocalizedString} */ ((i) => {
			return /** @type {LocalizedString} */ (`Nachdem du dein Konto erstellt hast, kannst du ${i?.appName} installieren`)
		}),
		{
			parts: /** @type {(inputs: Onboarding_Profile_Installbanner1Inputs) => import('../runtime.js').MessagePart[]} */ ((i) => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "Nachdem du dein Konto erstellt hast, kannst du " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: String(i?.appName) }, { type: "markup-end", name: "0", options: {}, attributes: {} }, { type: "text", value: " installieren" }])
			})
		}
	)
);
...
const ko_onboarding_profile_installbanner1 = /** @type {((inputs: Onboarding_Profile_Installbanner1Inputs) => LocalizedString) & { parts: (inputs: Onboarding_Profile_Installbanner1Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Onboarding_Profile_Installbanner1Inputs) => LocalizedString} */ ((i) => {
			return /** @type {LocalizedString} */ (`계정을 만든 후 ${i?.appName}을(를) 설치할 수 있습니다`)
		}),
		{
			parts: /** @type {(inputs: Onboarding_Profile_Installbanner1Inputs) => import('../runtime.js').MessagePart[]} */ ((i) => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "계정을 만든 후 " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: String(i?.appName) }, { type: "markup-end", name: "0", options: {}, attributes: {} }, { type: "text", value: "을(를) 설치할 수 있습니다" }])
			})
		}
	)
);
...
*/
const onboarding_profile_installbanner1 = /** @type {((inputs: Onboarding_Profile_Installbanner1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & { parts: (inputs: Onboarding_Profile_Installbanner1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => import('../runtime.js').MessagePart[] } & import('../runtime.js').MessageMetadata<Onboarding_Profile_Installbanner1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, { "0": { options: {}; attributes: {}; children: true } }>} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Onboarding_Profile_Installbanner1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString} */ ((inputs, options = {}) => {
			...
			if (locale === "de") return de_onboarding_profile_installbanner1(inputs)
			if (locale === "ar") return ar_onboarding_profile_installbanner1(inputs)
			if (locale === "fr") return fr_onboarding_profile_installbanner1(inputs)
			return ko_onboarding_profile_installbanner1(inputs)
		}),
		{
			parts: /** @type {(inputs: Onboarding_Profile_Installbanner1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => import('../runtime.js').MessagePart[]} */ ((inputs, options = {}) => {
				const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
				...
				if (locale === "de") return typeof de_onboarding_profile_installbanner1.parts === "function" ? de_onboarding_profile_installbanner1.parts(inputs) : [{ type: "text", value: de_onboarding_profile_installbanner1(inputs) }]
				if (locale === "ar") return typeof ar_onboarding_profile_installbanner1.parts === "function" ? ar_onboarding_profile_installbanner1.parts(inputs) : [{ type: "text", value: ar_onboarding_profile_installbanner1(inputs) }]
				...
				return typeof ko_onboarding_profile_installbanner1.parts === "function" ? ko_onboarding_profile_installbanner1.parts(inputs) : [{ type: "text", value: ko_onboarding_profile_installbanner1(inputs) }]
			})
		}
	)
);
