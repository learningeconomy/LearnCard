...
*/
const contacts_sharecode1 = /** @type {((inputs?: Contacts_Sharecode1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Contacts_Sharecode1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_contacts_sharecode1(inputs)
});
