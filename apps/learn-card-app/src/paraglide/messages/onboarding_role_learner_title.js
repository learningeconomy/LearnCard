...
*/
const onboarding_role_learner_title = /** @type {((inputs?: Onboarding_Role_Learner_TitleInputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Role_Learner_TitleInputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_onboarding_role_learner_title(inputs)
});
