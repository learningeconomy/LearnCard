...
const es_sidemenu_footer_connectionsencrypted1 = /** @type {((inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => LocalizedString) & { parts: (inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => LocalizedString} */ (() => {
			return /** @type {LocalizedString} */ (`Todas las conexiones están encriptadas.`)
		}),
		{
			parts: /** @type {(inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => import('../runtime.js').MessagePart[]} */ (() => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "Todas las conexiones están " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: "encriptadas." }, { type: "markup-end", name: "0", options: {}, attributes: {} }])
			})
		}
	)
);

const fr_sidemenu_footer_connectionsencrypted1 = /** @type {((inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => LocalizedString) & { parts: (inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => LocalizedString} */ (() => {
		...
		{
			parts: /** @type {(inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => import('../runtime.js').MessagePart[]} */ (() => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "Toutes les connexions sont " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: "chiffrées." }, { type: "markup-end", name: "0", options: {}, attributes: {} }])
			})
		}
	)
);
...
const ar_sidemenu_footer_connectionsencrypted1 = /** @type {((inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => LocalizedString) & { parts: (inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		...
		{
			parts: /** @type {(inputs: Sidemenu_Footer_Connectionsencrypted1Inputs) => import('../runtime.js').MessagePart[]} */ (() => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "جميع الاتصالات " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: "مشفرة." }, { type: "markup-end", name: "0", options: {}, attributes: {} }])
			})
		}
	)
);
...
*/
const sidemenu_footer_connectionsencrypted1 = /** @type {((inputs?: Sidemenu_Footer_Connectionsencrypted1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & { parts: (inputs?: Sidemenu_Footer_Connectionsencrypted1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => import('../runtime.js').MessagePart[] } & import('../runtime.js').MessageMetadata<Sidemenu_Footer_Connectionsencrypted1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, { "0": { options: {}; attributes: {}; children: true } }>} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs?: Sidemenu_Footer_Connectionsencrypted1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString} */ ((inputs = {}, options = {}) => {
			...
			if (locale === "fr") return fr_sidemenu_footer_connectionsencrypted1(inputs)
			return ar_sidemenu_footer_connectionsencrypted1(inputs)
		}),
		{
			parts: /** @type {(inputs?: Sidemenu_Footer_Connectionsencrypted1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => import('../runtime.js').MessagePart[]} */ ((inputs = {}, options = {}) => {
				const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
				...
				if (locale === "fr") return typeof fr_sidemenu_footer_connectionsencrypted1.parts === "function" ? fr_sidemenu_footer_connectionsencrypted1.parts(inputs) : [{ type: "text", value: fr_sidemenu_footer_connectionsencrypted1(inputs) }]
