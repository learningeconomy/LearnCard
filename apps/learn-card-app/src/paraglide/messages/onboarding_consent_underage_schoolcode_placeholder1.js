...
*/
const onboarding_consent_underage_schoolcode_placeholder1 = /** @type {((inputs?: Onboarding_Consent_Underage_Schoolcode_Placeholder1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Underage_Schoolcode_Placeholder1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_onboarding_consent_underage_schoolcode_placeholder1(inputs)
});
