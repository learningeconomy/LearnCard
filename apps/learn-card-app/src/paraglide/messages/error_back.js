...
const de_error_back = /** @type {(inputs: Error_BackInputs) => LocalizedString} */ () => {
...
const ko_error_back = /** @type {(inputs: Error_BackInputs) => LocalizedString} */ () => {
...
*/
const error_back = /** @type {((inputs?: Error_BackInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_BackInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_error_back(inputs)
	if (locale === "es") return es_error_back(inputs)
	if (locale === "de") return de_error_back(inputs)
	if (locale === "ar") return ar_error_back(inputs)
	if (locale === "fr") return fr_error_back(inputs)
	return ko_error_back(inputs)
});
