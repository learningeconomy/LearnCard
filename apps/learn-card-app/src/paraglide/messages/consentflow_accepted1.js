...
const de_consentflow_accepted1 = /** @type {(inputs: Consentflow_Accepted1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Angenommen`)
};
...
const ko_consentflow_accepted1 = /** @type {(inputs: Consentflow_Accepted1Inputs) => LocalizedString} */ () => {
...
*/
const consentflow_accepted1 = /** @type {((inputs?: Consentflow_Accepted1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Consentflow_Accepted1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_consentflow_accepted1(inputs)
	if (locale === "es") return es_consentflow_accepted1(inputs)
	if (locale === "de") return de_consentflow_accepted1(inputs)
	if (locale === "ar") return ar_consentflow_accepted1(inputs)
	if (locale === "fr") return fr_consentflow_accepted1(inputs)
	return ko_consentflow_accepted1(inputs)
});
