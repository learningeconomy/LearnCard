...
const fr_sidemenu_links_contacts = /** @type {(inputs: Sidemenu_Links_ContactsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Contacts`)
};

const ko_sidemenu_links_contacts = /** @type {(inputs: Sidemenu_Links_ContactsInputs) => LocalizedString} */ () => {
...
*/
const sidemenu_links_contacts = /** @type {((inputs?: Sidemenu_Links_ContactsInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sidemenu_Links_ContactsInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_sidemenu_links_contacts(inputs)
	if (locale === "fr") return fr_sidemenu_links_contacts(inputs)
	return ko_sidemenu_links_contacts(inputs)
});
