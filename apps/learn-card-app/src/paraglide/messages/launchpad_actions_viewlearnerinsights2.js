...
const de_launchpad_actions_viewlearnerinsights2 = /** @type {(inputs: Launchpad_Actions_Viewlearnerinsights2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Lernereinblicke anzeigen`)
};
...
const ko_launchpad_actions_viewlearnerinsights2 = /** @type {(inputs: Launchpad_Actions_Viewlearnerinsights2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`학습자 인사이트 보기`)
};
...
*/
const launchpad_actions_viewlearnerinsights2 = /** @type {((inputs?: Launchpad_Actions_Viewlearnerinsights2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Actions_Viewlearnerinsights2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_launchpad_actions_viewlearnerinsights2(inputs)
	if (locale === "ar") return ar_launchpad_actions_viewlearnerinsights2(inputs)
	if (locale === "fr") return fr_launchpad_actions_viewlearnerinsights2(inputs)
	return ko_launchpad_actions_viewlearnerinsights2(inputs)
});
