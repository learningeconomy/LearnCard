...
*/
const settings_privacy_profileprivacy1 = /** @type {((inputs?: Settings_Privacy_Profileprivacy1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Privacy_Profileprivacy1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_settings_privacy_profileprivacy1(inputs)
});
