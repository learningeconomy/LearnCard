...
*/
const toasts_consentflow_acceptfailed2 = /** @type {((inputs: Toasts_Consentflow_Acceptfailed2Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Consentflow_Acceptfailed2Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs, options = {}) => {
	...
	return ar_toasts_consentflow_acceptfailed2(inputs)
});
