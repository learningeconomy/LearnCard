...
const de_onboarding_consent_underage_addchild_description1 = /** @type {(inputs: Onboarding_Consent_Underage_Addchild_Description1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Melde dich an oder registriere dich, um dein Profil innerhalb eines Familienkontos zu erstellen.`)
};
...
const ko_onboarding_consent_underage_addchild_description1 = /** @type {(inputs: Onboarding_Consent_Underage_Addchild_Description1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`로그인 또는 가입하여 가족 계정 내에서 프로필을 만드세요.`)
};
...
*/
const onboarding_consent_underage_addchild_description1 = /** @type {((inputs?: Onboarding_Consent_Underage_Addchild_Description1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Underage_Addchild_Description1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_consent_underage_addchild_description1(inputs)
	if (locale === "ar") return ar_onboarding_consent_underage_addchild_description1(inputs)
	if (locale === "fr") return fr_onboarding_consent_underage_addchild_description1(inputs)
	return ko_onboarding_consent_underage_addchild_description1(inputs)
});
