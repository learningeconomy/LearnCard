...
const de_login_seedphrase_advancedoption2 = /** @type {((inputs: Login_Seedphrase_Advancedoption2Inputs) => LocalizedString) & { parts: (inputs: Login_Seedphrase_Advancedoption2Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Login_Seedphrase_Advancedoption2Inputs) => LocalizedString} */ (() => {
			return /** @type {LocalizedString} */ (`Dies ist eine erweiterte Option für Nutzer, die ihren Seed bereits bei der Ausweiserstellung gespeichert haben. Wenn du keinen Seed hast, musst du zurückgehen und stattdessen einen neuen Ausweis erstellen.`)
		}),
		{
			parts: /** @type {(inputs: Login_Seedphrase_Advancedoption2Inputs) => import('../runtime.js').MessagePart[]} */ (() => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "Dies ist eine erweiterte Option für Nutzer, die ihren Seed bereits bei der Ausweiserstellung gespeichert haben. Wenn du keinen Seed hast, musst du zurückgehen und stattdessen " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: "einen neuen Ausweis erstellen" }, { type: "markup-end", name: "0", options: {}, attributes: {} }, { type: "text", value: "." }])
			})
		}
	)
);
...
const ko_login_seedphrase_advancedoption2 = /** @type {((inputs: Login_Seedphrase_Advancedoption2Inputs) => LocalizedString) & { parts: (inputs: Login_Seedphrase_Advancedoption2Inputs) => import('../runtime.js').MessagePart[] }} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs: Login_Seedphrase_Advancedoption2Inputs) => LocalizedString} */ (() => {
			return /** @type {LocalizedString} */ (`이것은 패스포트 생성 중에 이미 시드를 저장한 사용자를 위한 고급 옵션입니다. 시드가 없으면 돌아가서 새 패스포트 만들기를 대신 선택해야 합니다.`)
		}),
		{
			parts: /** @type {(inputs: Login_Seedphrase_Advancedoption2Inputs) => import('../runtime.js').MessagePart[]} */ (() => {
				return /** @type {import('../runtime.js').MessagePart[]} */ ([{ type: "text", value: "이것은 패스포트 생성 중에 이미 시드를 저장한 사용자를 위한 고급 옵션입니다. 시드가 없으면 돌아가서 " }, { type: "markup-start", name: "0", options: {}, attributes: {} }, { type: "text", value: "새 패스포트 만들기" }, { type: "markup-end", name: "0", options: {}, attributes: {} }, { type: "text", value: "를 대신 선택해야 합니다." }])
			})
		}
	)
);
...
*/
const login_seedphrase_advancedoption2 = /** @type {((inputs?: Login_Seedphrase_Advancedoption2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & { parts: (inputs?: Login_Seedphrase_Advancedoption2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => import('../runtime.js').MessagePart[] } & import('../runtime.js').MessageMetadata<Login_Seedphrase_Advancedoption2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, { "0": { options: {}; attributes: {}; children: true } }>} */ (
	/* @__PURE__ */ Object.assign(
		/** @type {(inputs?: Login_Seedphrase_Advancedoption2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString} */ ((inputs = {}, options = {}) => {
			...
			if (locale === "de") return de_login_seedphrase_advancedoption2(inputs)
			if (locale === "ar") return ar_login_seedphrase_advancedoption2(inputs)
			if (locale === "fr") return fr_login_seedphrase_advancedoption2(inputs)
			return ko_login_seedphrase_advancedoption2(inputs)
		}),
		{
			parts: /** @type {(inputs?: Login_Seedphrase_Advancedoption2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => import('../runtime.js').MessagePart[]} */ ((inputs = {}, options = {}) => {
				const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
				...
				if (locale === "de") return typeof de_login_seedphrase_advancedoption2.parts === "function" ? de_login_seedphrase_advancedoption2.parts(inputs) : [{ type: "text", value: de_login_seedphrase_advancedoption2(inputs) }]
				if (locale === "ar") return typeof ar_login_seedphrase_advancedoption2.parts === "function" ? ar_login_seedphrase_advancedoption2.parts(inputs) : [{ type: "text", value: ar_login_seedphrase_advancedoption2(inputs) }]
				...
				return typeof ko_login_seedphrase_advancedoption2.parts === "function" ? ko_login_seedphrase_advancedoption2.parts(inputs) : [{ type: "text", value: ko_login_seedphrase_advancedoption2(inputs) }]
			})
		}
	)
);
