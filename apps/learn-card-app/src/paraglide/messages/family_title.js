...
const de_family_title = /** @type {(inputs: Family_TitleInputs) => LocalizedString} */ () => {
...
const ko_family_title = /** @type {(inputs: Family_TitleInputs) => LocalizedString} */ () => {
...
*/
const family_title = /** @type {((inputs?: Family_TitleInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Family_TitleInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_family_title(inputs)
	if (locale === "es") return es_family_title(inputs)
	if (locale === "de") return de_family_title(inputs)
	if (locale === "ar") return ar_family_title(inputs)
	if (locale === "fr") return fr_family_title(inputs)
	return ko_family_title(inputs)
});
