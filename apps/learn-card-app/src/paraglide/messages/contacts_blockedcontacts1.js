...
*/
const contacts_blockedcontacts1 = /** @type {((inputs?: Contacts_Blockedcontacts1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Contacts_Blockedcontacts1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_contacts_blockedcontacts1(inputs)
});
