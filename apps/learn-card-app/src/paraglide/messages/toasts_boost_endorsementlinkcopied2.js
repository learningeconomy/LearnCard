...
const de_toasts_boost_endorsementlinkcopied2 = /** @type {(inputs: Toasts_Boost_Endorsementlinkcopied2Inputs) => LocalizedString} */ () => {
...
const ko_toasts_boost_endorsementlinkcopied2 = /** @type {(inputs: Toasts_Boost_Endorsementlinkcopied2Inputs) => LocalizedString} */ () => {
...
*/
const toasts_boost_endorsementlinkcopied2 = /** @type {((inputs?: Toasts_Boost_Endorsementlinkcopied2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Boost_Endorsementlinkcopied2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_toasts_boost_endorsementlinkcopied2(inputs)
	if (locale === "ar") return ar_toasts_boost_endorsementlinkcopied2(inputs)
	if (locale === "fr") return fr_toasts_boost_endorsementlinkcopied2(inputs)
	return ko_toasts_boost_endorsementlinkcopied2(inputs)
});
