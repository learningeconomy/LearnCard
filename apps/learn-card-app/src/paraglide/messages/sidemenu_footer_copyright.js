...
*/
const sidemenu_footer_copyright = /** @type {((inputs: Sidemenu_Footer_CopyrightInputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sidemenu_Footer_CopyrightInputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs, options = {}) => {
