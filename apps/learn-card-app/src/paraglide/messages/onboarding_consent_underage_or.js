...
*/
const onboarding_consent_underage_or = /** @type {((inputs?: Onboarding_Consent_Underage_OrInputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Underage_OrInputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_onboarding_consent_underage_or(inputs)
});
