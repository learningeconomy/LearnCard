...
const de_profile_export_confirmbytyping2 = /** @type {(inputs: Profile_Export_Confirmbytyping2Inputs) => LocalizedString} */ () => {
...
const ko_profile_export_confirmbytyping2 = /** @type {(inputs: Profile_Export_Confirmbytyping2Inputs) => LocalizedString} */ () => {
...
*/
const profile_export_confirmbytyping2 = /** @type {((inputs?: Profile_Export_Confirmbytyping2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Profile_Export_Confirmbytyping2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_profile_export_confirmbytyping2(inputs)
	if (locale === "ar") return ar_profile_export_confirmbytyping2(inputs)
	if (locale === "fr") return fr_profile_export_confirmbytyping2(inputs)
	return ko_profile_export_confirmbytyping2(inputs)
});
