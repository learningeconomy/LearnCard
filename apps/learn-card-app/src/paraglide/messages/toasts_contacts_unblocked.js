...
const de_toasts_contacts_unblocked = /** @type {(inputs: Toasts_Contacts_UnblockedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Benutzer entblockiert`)
};
...
const ko_toasts_contacts_unblocked = /** @type {(inputs: Toasts_Contacts_UnblockedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`사용자 차단 해제됨`)
};
...
*/
const toasts_contacts_unblocked = /** @type {((inputs?: Toasts_Contacts_UnblockedInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Contacts_UnblockedInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_toasts_contacts_unblocked(inputs)
	if (locale === "ar") return ar_toasts_contacts_unblocked(inputs)
	if (locale === "fr") return fr_toasts_contacts_unblocked(inputs)
	return ko_toasts_contacts_unblocked(inputs)
});
