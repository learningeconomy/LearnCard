...
const de_settings_notifications_connectionrequests_description1 = /** @type {(inputs: Settings_Notifications_Connectionrequests_Description1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Wenn jemand Ihren Code scannt oder auf Ihre Benutzerlinks klickt, wird eine Netzwerkanfrage initiiert, die Sie akzeptieren oder ablehnen können.`)
};
...
const ko_settings_notifications_connectionrequests_description1 = /** @type {(inputs: Settings_Notifications_Connectionrequests_Description1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`누군가 귀하의 코드를 스캔하거나 귀하의 사용자 링크를 클릭하면 귀하가 수락하거나 거부할 수 있는 네트워크 요청이 시작됩니다.`)
};
...
const settings_notifications_connectionrequests_description1 = /** @type {((inputs?: Settings_Notifications_Connectionrequests_Description1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Notifications_Connectionrequests_Description1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_settings_notifications_connectionrequests_description1(inputs)
	if (locale === "ar") return ar_settings_notifications_connectionrequests_description1(inputs)
	if (locale === "fr") return fr_settings_notifications_connectionrequests_description1(inputs)
	return ko_settings_notifications_connectionrequests_description1(inputs)
});
