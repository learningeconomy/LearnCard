...
const de_profile_phonenumber1 = /** @type {(inputs: Profile_Phonenumber1Inputs) => LocalizedString} */ () => {
...
const ko_profile_phonenumber1 = /** @type {(inputs: Profile_Phonenumber1Inputs) => LocalizedString} */ () => {
...
*/
const profile_phonenumber1 = /** @type {((inputs?: Profile_Phonenumber1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Profile_Phonenumber1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_profile_phonenumber1(inputs)
	if (locale === "es") return es_profile_phonenumber1(inputs)
	if (locale === "de") return de_profile_phonenumber1(inputs)
	if (locale === "ar") return ar_profile_phonenumber1(inputs)
	if (locale === "fr") return fr_profile_phonenumber1(inputs)
	return ko_profile_phonenumber1(inputs)
});
