...
*/
const launchpad_actions_createfamily1 = /** @type {((inputs?: Launchpad_Actions_Createfamily1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Actions_Createfamily1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_launchpad_actions_createfamily1(inputs)
});
