...
const ko_launchpad_header_aisessions1 = /** @type {(inputs: Launchpad_Header_Aisessions1Inputs) => LocalizedString} */ () => {
...
*/
const launchpad_header_aisessions1 = /** @type {((inputs?: Launchpad_Header_Aisessions1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Header_Aisessions1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_launchpad_header_aisessions1(inputs)
	if (locale === "fr") return fr_launchpad_header_aisessions1(inputs)
	return ko_launchpad_header_aisessions1(inputs)
});
