...
*/
const recovery_generatenewphrase2 = /** @type {((inputs?: Recovery_Generatenewphrase2Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Recovery_Generatenewphrase2Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_recovery_generatenewphrase2(inputs)
});
