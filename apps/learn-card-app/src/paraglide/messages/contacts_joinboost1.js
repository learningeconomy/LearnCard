...
*/
const contacts_joinboost1 = /** @type {((inputs?: Contacts_Joinboost1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Contacts_Joinboost1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_contacts_joinboost1(inputs)
});
