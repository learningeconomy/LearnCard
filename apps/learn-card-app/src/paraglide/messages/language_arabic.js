...
const ko_language_arabic = /** @type {(inputs: Language_ArabicInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`العربية`)
};
...
*/
const language_arabic = /** @type {((inputs?: Language_ArabicInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Language_ArabicInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_language_arabic(inputs)
	if (locale === "fr") return fr_language_arabic(inputs)
	return ko_language_arabic(inputs)
});
