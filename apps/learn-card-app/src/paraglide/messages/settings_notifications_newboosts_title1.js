...
const de_settings_notifications_newboosts_title1 = /** @type {(inputs: Settings_Notifications_Newboosts_Title1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Neue Boosts`)
};
...
const ko_settings_notifications_newboosts_title1 = /** @type {(inputs: Settings_Notifications_Newboosts_Title1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`새로운 부스트`)
};
...
*/
const settings_notifications_newboosts_title1 = /** @type {((inputs?: Settings_Notifications_Newboosts_Title1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Notifications_Newboosts_Title1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_settings_notifications_newboosts_title1(inputs)
	if (locale === "ar") return ar_settings_notifications_newboosts_title1(inputs)
	if (locale === "fr") return fr_settings_notifications_newboosts_title1(inputs)
	return ko_settings_notifications_newboosts_title1(inputs)
});
