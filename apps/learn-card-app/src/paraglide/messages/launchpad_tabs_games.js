...
const ko_launchpad_tabs_games = /** @type {(inputs: Launchpad_Tabs_GamesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`게임`)
};
...
*/
const launchpad_tabs_games = /** @type {((inputs?: Launchpad_Tabs_GamesInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Tabs_GamesInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_launchpad_tabs_games(inputs)
	if (locale === "fr") return fr_launchpad_tabs_games(inputs)
	return ko_launchpad_tabs_games(inputs)
});
