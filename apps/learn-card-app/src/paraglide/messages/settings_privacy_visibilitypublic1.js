...
*/
const settings_privacy_visibilitypublic1 = /** @type {((inputs?: Settings_Privacy_Visibilitypublic1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Privacy_Visibilitypublic1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_settings_privacy_visibilitypublic1(inputs)
});
