...
*/
const sidemenu_links_aipathways1 = /** @type {((inputs?: Sidemenu_Links_Aipathways1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sidemenu_Links_Aipathways1Inputs, { locale?: "en" | "es" | "de" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
