...
const de_onboarding_consent_underage_schoolcode_heading1 = /** @type {(inputs: Onboarding_Consent_Underage_Schoolcode_Heading1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Schulcode eingeben`)
};
...
const ko_onboarding_consent_underage_schoolcode_heading1 = /** @type {(inputs: Onboarding_Consent_Underage_Schoolcode_Heading1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`학교 코드 입력`)
};
...
*/
const onboarding_consent_underage_schoolcode_heading1 = /** @type {((inputs?: Onboarding_Consent_Underage_Schoolcode_Heading1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Underage_Schoolcode_Heading1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_consent_underage_schoolcode_heading1(inputs)
	if (locale === "ar") return ar_onboarding_consent_underage_schoolcode_heading1(inputs)
	if (locale === "fr") return fr_onboarding_consent_underage_schoolcode_heading1(inputs)
	return ko_onboarding_consent_underage_schoolcode_heading1(inputs)
});
