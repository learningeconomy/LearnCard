...
*/
const onboarding_consent_underage_loggingout_description1 = /** @type {((inputs?: Onboarding_Consent_Underage_Loggingout_Description1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Underage_Loggingout_Description1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_onboarding_consent_underage_loggingout_description1(inputs)
});
