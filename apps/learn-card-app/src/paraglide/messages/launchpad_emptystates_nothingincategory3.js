...
*/
const launchpad_emptystates_nothingincategory3 = /** @type {((inputs: Launchpad_Emptystates_Nothingincategory3Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Emptystates_Nothingincategory3Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs, options = {}) => {
