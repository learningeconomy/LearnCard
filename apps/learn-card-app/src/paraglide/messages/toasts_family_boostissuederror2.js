...
const de_toasts_family_boostissuederror2 = /** @type {(inputs: Toasts_Family_Boostissuederror2Inputs) => LocalizedString} */ () => {
...
const ko_toasts_family_boostissuederror2 = /** @type {(inputs: Toasts_Family_Boostissuederror2Inputs) => LocalizedString} */ () => {
...
*/
const toasts_family_boostissuederror2 = /** @type {((inputs?: Toasts_Family_Boostissuederror2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Family_Boostissuederror2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_toasts_family_boostissuederror2(inputs)
	if (locale === "ar") return ar_toasts_family_boostissuederror2(inputs)
	if (locale === "fr") return fr_toasts_family_boostissuederror2(inputs)
	return ko_toasts_family_boostissuederror2(inputs)
});
