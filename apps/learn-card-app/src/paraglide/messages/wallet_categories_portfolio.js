...
const ar_wallet_categories_portfolio = /** @type {(inputs: Wallet_Categories_PortfolioInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`ملف الأعمال`)
};
...
*/
const wallet_categories_portfolio = /** @type {((inputs?: Wallet_Categories_PortfolioInputs, options?: { locale?: "en" | "es" | "de" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Wallet_Categories_PortfolioInputs, { locale?: "en" | "es" | "de" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
