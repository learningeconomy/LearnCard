...
*/
const launchpad_agerestriction_notmeetrequirement3 = /** @type {((inputs?: Launchpad_Agerestriction_Notmeetrequirement3Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Agerestriction_Notmeetrequirement3Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_launchpad_agerestriction_notmeetrequirement3(inputs)
});
