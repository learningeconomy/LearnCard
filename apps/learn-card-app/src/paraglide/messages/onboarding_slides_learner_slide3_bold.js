...
const de_onboarding_slides_learner_slide3_bold = /** @type {(inputs: Onboarding_Slides_Learner_Slide3_BoldInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Lerne`)
};
...
const ko_onboarding_slides_learner_slide3_bold = /** @type {(inputs: Onboarding_Slides_Learner_Slide3_BoldInputs) => LocalizedString} */ () => {
...
*/
const onboarding_slides_learner_slide3_bold = /** @type {((inputs?: Onboarding_Slides_Learner_Slide3_BoldInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Slides_Learner_Slide3_BoldInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_slides_learner_slide3_bold(inputs)
	if (locale === "ar") return ar_onboarding_slides_learner_slide3_bold(inputs)
	if (locale === "fr") return fr_onboarding_slides_learner_slide3_bold(inputs)
	return ko_onboarding_slides_learner_slide3_bold(inputs)
});
