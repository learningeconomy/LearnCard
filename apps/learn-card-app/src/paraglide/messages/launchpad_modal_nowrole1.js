...
*/
const launchpad_modal_nowrole1 = /** @type {((inputs: Launchpad_Modal_Nowrole1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Modal_Nowrole1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs, options = {}) => {
	...
	return ar_launchpad_modal_nowrole1(inputs)
});
