...
*/
const boost_managedtab1 = /** @type {((inputs?: Boost_Managedtab1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Boost_Managedtab1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_boost_managedtab1(inputs)
});
