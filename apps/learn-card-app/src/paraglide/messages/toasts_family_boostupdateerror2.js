...
const de_toasts_family_boostupdateerror2 = /** @type {(inputs: Toasts_Family_Boostupdateerror2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Fehler beim Aktualisieren des Boosts`)
};
...
const ko_toasts_family_boostupdateerror2 = /** @type {(inputs: Toasts_Family_Boostupdateerror2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`부스트 업데이트 오류`)
};
...
*/
const toasts_family_boostupdateerror2 = /** @type {((inputs?: Toasts_Family_Boostupdateerror2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Family_Boostupdateerror2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_toasts_family_boostupdateerror2(inputs)
	if (locale === "ar") return ar_toasts_family_boostupdateerror2(inputs)
	if (locale === "fr") return fr_toasts_family_boostupdateerror2(inputs)
	return ko_toasts_family_boostupdateerror2(inputs)
});
