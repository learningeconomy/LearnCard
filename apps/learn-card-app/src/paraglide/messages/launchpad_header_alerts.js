...
const ko_launchpad_header_alerts = /** @type {(inputs: Launchpad_Header_AlertsInputs) => LocalizedString} */ () => {
...
*/
const launchpad_header_alerts = /** @type {((inputs?: Launchpad_Header_AlertsInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Header_AlertsInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_launchpad_header_alerts(inputs)
	if (locale === "fr") return fr_launchpad_header_alerts(inputs)
	return ko_launchpad_header_alerts(inputs)
});
