...
const de_launchpad_modal_unabletoupdaterole3 = /** @type {(inputs: Launchpad_Modal_Unabletoupdaterole3Inputs) => LocalizedString} */ () => {
...
const ko_launchpad_modal_unabletoupdaterole3 = /** @type {(inputs: Launchpad_Modal_Unabletoupdaterole3Inputs) => LocalizedString} */ () => {
...
*/
const launchpad_modal_unabletoupdaterole3 = /** @type {((inputs?: Launchpad_Modal_Unabletoupdaterole3Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Modal_Unabletoupdaterole3Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_launchpad_modal_unabletoupdaterole3(inputs)
	if (locale === "ar") return ar_launchpad_modal_unabletoupdaterole3(inputs)
	if (locale === "fr") return fr_launchpad_modal_unabletoupdaterole3(inputs)
	return ko_launchpad_modal_unabletoupdaterole3(inputs)
});
