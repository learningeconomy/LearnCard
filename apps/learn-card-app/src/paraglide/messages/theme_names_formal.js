...
const ko_theme_names_formal = /** @type {(inputs: Theme_Names_FormalInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Formal`)
};
...
*/
const theme_names_formal = /** @type {((inputs?: Theme_Names_FormalInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Theme_Names_FormalInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "ar") return ar_theme_names_formal(inputs)
	if (locale === "fr") return fr_theme_names_formal(inputs)
	return ko_theme_names_formal(inputs)
});
