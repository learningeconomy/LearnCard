...
*/
const recovery_action_generatephrase1 = /** @type {((inputs?: Recovery_Action_Generatephrase1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Recovery_Action_Generatephrase1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_recovery_action_generatephrase1(inputs)
});
