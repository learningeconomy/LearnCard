...
const de_launchpad_actions_manageskillsframeworks2 = /** @type {(inputs: Launchpad_Actions_Manageskillsframeworks2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Fähigkeitsrahmen verwalten`)
};
...
const ko_launchpad_actions_manageskillsframeworks2 = /** @type {(inputs: Launchpad_Actions_Manageskillsframeworks2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`기술 프레임워크 관리`)
};
...
*/
const launchpad_actions_manageskillsframeworks2 = /** @type {((inputs?: Launchpad_Actions_Manageskillsframeworks2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Actions_Manageskillsframeworks2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_launchpad_actions_manageskillsframeworks2(inputs)
	if (locale === "ar") return ar_launchpad_actions_manageskillsframeworks2(inputs)
	if (locale === "fr") return fr_launchpad_actions_manageskillsframeworks2(inputs)
	return ko_launchpad_actions_manageskillsframeworks2(inputs)
});
