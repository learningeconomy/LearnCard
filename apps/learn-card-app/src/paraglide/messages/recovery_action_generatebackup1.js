...
const de_recovery_action_generatebackup1 = /** @type {(inputs: Recovery_Action_Generatebackup1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Sicherungsdatei generieren`)
};
...
const ko_recovery_action_generatebackup1 = /** @type {(inputs: Recovery_Action_Generatebackup1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`백업 파일 생성`)
};
...
*/
const recovery_action_generatebackup1 = /** @type {((inputs?: Recovery_Action_Generatebackup1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Recovery_Action_Generatebackup1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_recovery_action_generatebackup1(inputs)
	if (locale === "ar") return ar_recovery_action_generatebackup1(inputs)
	if (locale === "fr") return fr_recovery_action_generatebackup1(inputs)
	return ko_recovery_action_generatebackup1(inputs)
});
