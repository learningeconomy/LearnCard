...
*/
const launchpad_tabs_employment = /** @type {((inputs?: Launchpad_Tabs_EmploymentInputs, options?: { locale?: "en" | "es" | "de" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Tabs_EmploymentInputs, { locale?: "en" | "es" | "de" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
