...
*/
const launchpad_detail_whyusethisapp3 = /** @type {((inputs?: Launchpad_Detail_Whyusethisapp3Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Detail_Whyusethisapp3Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_launchpad_detail_whyusethisapp3(inputs)
});
