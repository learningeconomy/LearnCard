...
const de_profile_phone_setasprimary2 = /** @type {(inputs: Profile_Phone_Setasprimary2Inputs) => LocalizedString} */ () => {
...
const ko_profile_phone_setasprimary2 = /** @type {(inputs: Profile_Phone_Setasprimary2Inputs) => LocalizedString} */ () => {
...
*/
const profile_phone_setasprimary2 = /** @type {((inputs?: Profile_Phone_Setasprimary2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Profile_Phone_Setasprimary2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_profile_phone_setasprimary2(inputs)
	if (locale === "ar") return ar_profile_phone_setasprimary2(inputs)
	if (locale === "fr") return fr_profile_phone_setasprimary2(inputs)
	return ko_profile_phone_setasprimary2(inputs)
});
