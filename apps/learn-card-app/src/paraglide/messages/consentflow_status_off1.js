...
*/
const consentflow_status_off1 = /** @type {((inputs?: Consentflow_Status_Off1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Consentflow_Status_Off1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_consentflow_status_off1(inputs)
});
