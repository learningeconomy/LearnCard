...
const de_profile_export_revealprompt1 = /** @type {(inputs: Profile_Export_Revealprompt1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ich verstehe – offenbare meinen Samen`)
};
...
const ko_profile_export_revealprompt1 = /** @type {(inputs: Profile_Export_Revealprompt1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`이해합니다 - 내 씨앗을 공개하세요`)
};
...
*/
const profile_export_revealprompt1 = /** @type {((inputs?: Profile_Export_Revealprompt1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Profile_Export_Revealprompt1Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_profile_export_revealprompt1(inputs)
	if (locale === "ar") return ar_profile_export_revealprompt1(inputs)
	if (locale === "fr") return fr_profile_export_revealprompt1(inputs)
	return ko_profile_export_revealprompt1(inputs)
});
