...
const de_onboarding_slides_admin_slide2_regular = /** @type {(inputs: Onboarding_Slides_Admin_Slide2_RegularInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`deine Lernenden, Lehrer und Lernerfahrungen`)
};
...
const ko_onboarding_slides_admin_slide2_regular = /** @type {(inputs: Onboarding_Slides_Admin_Slide2_RegularInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`학습자, 교사 및 학습 경험`)
};
...
*/
const onboarding_slides_admin_slide2_regular = /** @type {((inputs?: Onboarding_Slides_Admin_Slide2_RegularInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Slides_Admin_Slide2_RegularInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_slides_admin_slide2_regular(inputs)
	if (locale === "ar") return ar_onboarding_slides_admin_slide2_regular(inputs)
	if (locale === "fr") return fr_onboarding_slides_admin_slide2_regular(inputs)
	return ko_onboarding_slides_admin_slide2_regular(inputs)
});
