...
const de_theme_names_colorful = /** @type {(inputs: Theme_Names_ColorfulInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Colorful`)
};
...
const ko_theme_names_colorful = /** @type {(inputs: Theme_Names_ColorfulInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Colorful`)
};
...
*/
const theme_names_colorful = /** @type {((inputs?: Theme_Names_ColorfulInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Theme_Names_ColorfulInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_theme_names_colorful(inputs)
	if (locale === "es") return es_theme_names_colorful(inputs)
	if (locale === "de") return de_theme_names_colorful(inputs)
	if (locale === "ar") return ar_theme_names_colorful(inputs)
	if (locale === "fr") return fr_theme_names_colorful(inputs)
	return ko_theme_names_colorful(inputs)
});
