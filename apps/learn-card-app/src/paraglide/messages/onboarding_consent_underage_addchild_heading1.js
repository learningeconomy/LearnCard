...
*/
const onboarding_consent_underage_addchild_heading1 = /** @type {((inputs: Onboarding_Consent_Underage_Addchild_Heading1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Consent_Underage_Addchild_Heading1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs, options = {}) => {
	...
	return ar_onboarding_consent_underage_addchild_heading1(inputs)
});
