...
const de_onboarding_slides_teacher_slide2_bold = /** @type {(inputs: Onboarding_Slides_Teacher_Slide2_BoldInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Erstelle und verwalte`)
};
...
const ko_onboarding_slides_teacher_slide2_bold = /** @type {(inputs: Onboarding_Slides_Teacher_Slide2_BoldInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`맞춤형 자격 증명`)
};
...
*/
const onboarding_slides_teacher_slide2_bold = /** @type {((inputs?: Onboarding_Slides_Teacher_Slide2_BoldInputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Slides_Teacher_Slide2_BoldInputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_onboarding_slides_teacher_slide2_bold(inputs)
	if (locale === "ar") return ar_onboarding_slides_teacher_slide2_bold(inputs)
	if (locale === "fr") return fr_onboarding_slides_teacher_slide2_bold(inputs)
	return ko_onboarding_slides_teacher_slide2_bold(inputs)
});
