...
*/
const contacts_requestconnection1 = /** @type {((inputs?: Contacts_Requestconnection1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Contacts_Requestconnection1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_contacts_requestconnection1(inputs)
});
