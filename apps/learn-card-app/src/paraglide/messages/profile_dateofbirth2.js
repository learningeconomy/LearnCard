...
*/
const profile_dateofbirth2 = /** @type {((inputs?: Profile_Dateofbirth2Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Profile_Dateofbirth2Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_profile_dateofbirth2(inputs)
});
