...
*/
const recovery_incorrectcode1 = /** @type {((inputs?: Recovery_Incorrectcode1Inputs, options?: { locale?: "en" | "es" | "fr" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Recovery_Incorrectcode1Inputs, { locale?: "en" | "es" | "fr" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return ar_recovery_incorrectcode1(inputs)
});
