...
*/
const launchpad_tabs_myapps1 = /** @type {((inputs?: Launchpad_Tabs_Myapps1Inputs, options?: { locale?: "en" | "es" | "de" | "ar" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launchpad_Tabs_Myapps1Inputs, { locale?: "en" | "es" | "de" | "ar" }, {}>} */ ((inputs = {}, options = {}) => {
