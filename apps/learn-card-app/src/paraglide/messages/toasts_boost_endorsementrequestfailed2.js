...
const de_toasts_boost_endorsementrequestfailed2 = /** @type {(inputs: Toasts_Boost_Endorsementrequestfailed2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Endorsement-Anfrage konnte nicht gesendet werden`)
};
...
const ko_toasts_boost_endorsementrequestfailed2 = /** @type {(inputs: Toasts_Boost_Endorsementrequestfailed2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`보증 요청 전송 실패`)
};
...
*/
const toasts_boost_endorsementrequestfailed2 = /** @type {((inputs?: Toasts_Boost_Endorsementrequestfailed2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Boost_Endorsementrequestfailed2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_toasts_boost_endorsementrequestfailed2(inputs)
	if (locale === "ar") return ar_toasts_boost_endorsementrequestfailed2(inputs)
	if (locale === "fr") return fr_toasts_boost_endorsementrequestfailed2(inputs)
	return ko_toasts_boost_endorsementrequestfailed2(inputs)
});
