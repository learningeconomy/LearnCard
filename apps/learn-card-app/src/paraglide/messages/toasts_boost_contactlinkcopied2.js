...
const de_toasts_boost_contactlinkcopied2 = /** @type {(inputs: Toasts_Boost_Contactlinkcopied2Inputs) => LocalizedString} */ () => {
...
const ko_toasts_boost_contactlinkcopied2 = /** @type {(inputs: Toasts_Boost_Contactlinkcopied2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`연락처 링크가 클립보드에 복사됨`)
};
...
*/
const toasts_boost_contactlinkcopied2 = /** @type {((inputs?: Toasts_Boost_Contactlinkcopied2Inputs, options?: { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Toasts_Boost_Contactlinkcopied2Inputs, { locale?: "en" | "es" | "de" | "ar" | "fr" | "ko" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_toasts_boost_contactlinkcopied2(inputs)
	if (locale === "ar") return ar_toasts_boost_contactlinkcopied2(inputs)
	if (locale === "fr") return fr_toasts_boost_contactlinkcopied2(inputs)
	return ko_toasts_boost_contactlinkcopied2(inputs)
});
