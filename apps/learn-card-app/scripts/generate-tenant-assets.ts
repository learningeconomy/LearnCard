...
Example:
  bunx tsx scripts/generate-tenant-assets.ts vetpass ~/icon.png --bg "#1A3C5E" --name "VetPass"
  bunx tsx scripts/generate-tenant-assets.ts vetpass ~/icon.png --bg "#1A3C5E" \\
...
`);
    ...
    log.info(`  2. Run:  bunx tsx scripts/prepare-native-config.ts ${tenant}`);
